...
arxiv_id: "2510.23969"
title:
  "emg2speech: Synthesizing speech from electromyography using self-supervised
  speech models"
authors:
...
where $`||\cdot||_{F}`$ denotes the Frobenius norm. Here, $`\mathcal{L}_{1}`$ and $`\mathcal{L}_{2}`$ are the _Cholesky factors_ of the SPD matrices $`\mathcal{E}_{1}`$ and $`\mathcal{E}_{2}`$, i.e., lower triangular matrices such that $`\mathcal{E}=\mathcal{L}\mathcal{L}^{\top}`$.\
...
We then minimize a cross-entropy loss between $`\tilde{P}(\textsc{phoneme}\mid\textsc{EMG})_{t}`$ and the phoneme-head posterior $`P(\textsc{phoneme}\mid\textsc{EMG})_{t}`$ (see appendix B*"HuBERT" ‣ emg2speech: synthesizing speech from electromyography using self-supervised speech models") for more details). At inference time, we decode only $`\texttt{dis}(\mathcal{H})*{\textsc{HuBERT}}`$ units from the unit head using greedy decoding. Resulting improvement is shown in table 3.
...
- Benster et al. (2024) Tyler Benster, Guy Wilson, Reshef Elisha, Francis R Willett, and Shaul Druckmann. 2024. A cross-modal approach to silent speech with llm-enhanced recognition. _arXiv preprint arXiv:2403.05583_.
...
- Cho et al. (2024) Cheol Jun Cho, Abdelrahman Mohamed, Alan W Black, and Gopala K Anumanchipalli. 2024. Self-supervised models of speech infer universal articulatory kinematics. In _ICASSP 2024-2024 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pages 12061–12065. IEEE.
...
- Diener et al. (2018) Lorenz Diener, Gerrit Felsch, Miguel Angrick, and Tanja Schultz. 2018. Session-independent array-based emg-to-speech conversion using convolutional neural networks. In _Speech Communication; 13th ITG-Symposium_, pages 1–5.
- Fan et al. (2023) Chaofei Fan, Nick Hahn, Foram Kamdar, Donald Avansino, Guy Wilson, Leigh Hochberg, Krishna V Shenoy, Jaimie Henderson, and Francis Willett. 2023. Plug-and-play stability for intracortical brain-computer interfaces: a one-year demonstration of seamless brain-to-text communication. _Advances in neural information processing systems_, 36:42258–42270.
- Gaddy and Klein (2020) David Gaddy and Dan Klein. 2020. Digital voicing of silent speech. In _Proceedings of the 2020 Conference on Empirical Methods in Natural Language Processing (EMNLP)_, pages 5521–5530.
- Gaddy and Klein (2021) David Gaddy and Dan Klein. 2021. An improved model for voicing silent speech. In _Proceedings of the 59th Annual Meeting of the Association for Computational Linguistics and the 11th International Joint Conference on Natural Language Processing (Volume 2: Short Papers)_, pages 175–181.
...
- Halliday and Farmer (2010) D. M. Halliday and S. F. Farmer. 2010. [On the need for rectification of surface emg](https://doi.org/10.1152/jn.00222.2010). _Journal of Neurophysiology_, 103(6):3547.
...
- Janke and Diener (2017) Matthias Janke and Lorenz Diener. 2017. [Emg-to-speech: Direct generation of speech from facial electromyographic signals](https://doi.org/10.1109/TASLP.2017.2738568). _IEEE/ACM Transactions on Audio, Speech, and Language Processing_, 25(12):2375–2385.
- Jou et al. (2006) Szu-Chen Jou, Tanja Schultz, Matthias Walliczek, Florian Kraft, and Alex Waibel. 2006. Towards continuous speech recognition using surface electromyography. In _Ninth International Conference on Spoken Language Processing_.
- Kaifosh et al. (2025) Patrick Kaifosh, Thomas R. Reardon, and CTRL labs at Reality Labs. 2025. [A generic non-invasive neuromotor interface for human-computer interaction](https://doi.org/10.1038/s41586-025-09255-w). _Nature_, 645:702–711.
- Kaplan et al. (2020) Jared Kaplan, Sam McCandlish, Tom Henighan, Tom B Brown, Benjamin Chess, Rewon Child, Scott Gray, Alec Radford, Jeffrey Wu, and Dario Amodei. 2020. Scaling laws for neural language models. _arXiv preprint arXiv:2001.08361_.
- Kapur et al. (2020) Arnav Kapur, Utkarsh Sarawgi, Eric Wadkins, Matthew Wu, Nora Hollenstein, and Pattie Maes. 2020. Non-invasive silent speech recognition in multiple sclerosis with dysphonia. In _Machine Learning for Health Workshop_, pages 25–38. PMLR.
- Kaufman and Rousseeuw (1990) Leonard Kaufman and Peter J. Rousseeuw. 1990. [Partitioning around medoids (program pam)](https://doi.org/10.1002/9780470316801.ch2). In _Wiley Series in Probability and Statistics_, pages 68–125. John Wiley & Sons, Inc., Hoboken, NJ, USA. Retrieved 2021-06-13.
- Kim et al. (2021) Minsu Kim, Joanna Hong, and Yong Man Ro. 2021. Lip to speech synthesis with visual context attentional gan. _Advances in Neural Information Processing Systems_, 34:2758–2770.
...
- Lin (2019) Zhenhua Lin. 2019. Riemannian geometry of symmetric positive definite matrices via cholesky decomposition. _SIAM Journal on Matrix Analysis and Applications_, 40(4):1353–1370.
- Littlejohn et al. (2025) Kaylo T Littlejohn, Cheol Jun Cho, Jessie R Liu, Alexander B Silva, Bohan Yu, Vanessa R Anderson, Cady M Kurtz-Miott, Samantha Brosler, Anshul P Kashyap, Irina P Hallinan, and 1 others. 2025. A streaming brain-to-voice neuroprosthesis to restore naturalistic communication. _Nature neuroscience_, pages 1–11.
- Meltzner et al. (2018) Geoffrey S Meltzner, James T Heaton, Yunbin Deng, Gianluca De Luca, Serge H Roy, and Joshua C Kline. 2018. Development of semg sensors and algorithms for silent speech recognition. _Journal of neural engineering_, 15(4):046031.
- Metzger et al. (2023) Sean L Metzger, Kaylo T Littlejohn, Alexander B Silva, David A Moses, Margaret P Seaton, Ran Wang, Maximilian E Dougherty, Jessie R Liu, Peter Wu, Michael A Berger, and 1 others. 2023. A high-performance neuroprosthesis for speech decoding and avatar control. _Nature_, 620(7976):1037–1046.
- Mines et al. (1978) M. A. Mines, B. F. Hanson, and J. E. Shoup. 1978. [Frequency of occurrence of phonemes in conversational english](https://doi.org/10.1177/002383097802100302). _Language and Speech_, 21(3):221–241.
- Mohri et al. (2008) Mehryar Mohri, Fernando C. N. Pereira, and Michael Riley. 2008. [Speech recognition with weighted finite-state transducers](http://www.cs.nyu.edu/~mohri/postscript/hbka.pdf). In _Handbook on Speech Processing and Speech Communication, Part E: Speech recognition_.
...
- Sivakumar et al. (2024) Viswanath Sivakumar, Jeffrey Seely, Alan Du, Sean R Bittner, Adam Berenzweig, Anuoluwapo Bolarinwa, Alexandre Gramfort, and Michael I Mandel. 2024. emg2qwerty: A large dataset with baselines for touch typing using surface electromyography. In _The Thirty-eighth Conference on Neural Information Processing Systems Datasets and Benchmarks Track_.
- Toth et al. (2009) Arthur R. Toth, Michael Wand, and Tanja Schultz. 2009. [Synthesizing speech from electromyography using voice transformation techniques](https://doi.org/10.21437/Interspeech.2009-229). In _Interspeech 2009_, pages 652–655.
- Wairagkar et al. (2025) Maitreyee Wairagkar, Nicholas S Card, Tyler Singer-Clark, Xianda Hou, Carrina Iacobacci, Lee M Miller, Leigh R Hochberg, David M Brandman, and Sergey D Stavisky. 2025. An instantaneous voice-synthesis neuroprosthesis. _Nature_, pages 1–8.
...
- Willett et al. (2023) Francis R Willett, Erin M Kunz, Chaofei Fan, Donald T Avansino, Guy H Wilson, Eun Young Choi, Foram Kamdar, Matthew F Glasser, Leigh R Hochberg, Shaul Druckmann, and 1 others. 2023. A high-performance speech neuroprosthesis. _Nature_, 620(7976):1031–1036.
- Wilson et al. (2025) Guy H Wilson, Elias A Stein, Foram Kamdar, Donald T Avansino, Tsam Kiu Pun, Ronnie Gross, Tommy Hosman, Tyler Singer-Clark, Anastasia Kapitonava, Leigh R Hochberg, and 1 others. 2025. Long-term unsupervised recalibration of cursor-based intracortical brain–computer interfaces using a hidden markov model. _Nature Biomedical Engineering_, pages 1–19.
- Wolters et al. (2010) Maria K Wolters, Karl B Isaac, and Steve Renals. 2010. Evaluating speech synthesis intelligibility using amazon mechanical turk. In _Proc. 7th Speech Synthesis Workshop (SSW7)_, pages 136–141.
...
We further probe the structure of $`P(\textsc{phoneme}\mid\texttt{dis}(\mathcal{H})_{\textsc{HuBERT}})`$. In figure 6*"HuBERT" ‣ emg2speech: synthesizing speech from electromyography using self-supervised speech models"), we visualize, for each HuBERT unit, the phoneme with the highest conditional probability (i.e., $`\texttt{argmax}*{\textsc{phoneme}}P(\textsc{phoneme}\mid\text{u})`$). Multiple HuBERT units may map to the same most-probable phoneme p. In such cases, for each phoneme p, we order the corresponding units by increasing entropy of $`P(\cdot\mid\text{u})`$; lower entropy indicates a sharper, more confident association between the unit and phoneme p. We find that alveolar consonants (e.g., T, S, N) and A and I based vowels (e.g., AA, AY, AH, IY, IH) have many HuBERT units mapping to them.
