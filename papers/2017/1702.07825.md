...
2. Amodei, Dario, Anubhai, Rishita, Battenberg, Eric, Case, Carl, Casper, Jared,
...
3. Boersma, Paulus Petrus~Gerardus et~al.
\newblock Praat, a system for doing phonetics by computer.
\newblock \emph{Glot international}, 5, 2002.
4. Bradbury, James, Merity, Stephen, Xiong, Caiming, and Socher, Richard.
...
5. Chung, Junyoung, Gulcehre, Caglar, Cho, KyungHyun, and Bengio, Yoshua.
\newblock Empirical evaluation of gated recurrent neural networks on sequence
  modeling.
\newblock \emph{arXiv preprint arXiv:1412.3555}, 2014. [arXiv:1412.3555](https://arxiv.org/abs/1412.3555)
6. Diamos, Greg, Sengupta, Shubho, Catanzaro, Bryan, Chrzanowski, Mike, Coates,
...
8. Graves, Alex, Fern\'{a}ndez, Santiago, Gomez, Faustino, and Schmidhuber,
  J\"{u}rgen.
...
10. Mehri, Soroush, Kumar, Kundan, Gulrajani, Ishaan, Kumar, Rithesh, Jain,
...
11. Morise, Masanori, Yokomori, Fumiya, and Ozawa, Kenji.
...
12. Oord, Aaron van~den, Kalchbrenner, Nal, and Kavukcuoglu, Koray.
...
13. Paine, Tom~Le, Khorrami, Pooya, Chang, Shiyu, Zhang, Yang, Ramachandran,
...
14. Pascual, Santiago and Bonafonte, Antonio.
...
15. Prahallad, Kishore, Vadapalli, Anandaswarup, Elluru, Naresh, et~al.
\newblock The blizzard challenge 2013–indian language task.
\newblock In \emph{In Blizzard Challenge Workshop 2013}, 2013.
16. Rao, Kanishka, Peng, Fuchun, Sak, Ha{\c{s}}im, and Beaufays, Fran{\c{c}}oise.
...
17. Ribeiro, Fl{\'a}vio, Flor{\^e}ncio, Dinei, Zhang, Cha, and Seltzer, Michael.
...
18. Ronanki, Srikanth, Henter, Gustav~Eje, Wu, Zhizheng, and King, Simon.
...
19. Sotelo, Jose, Mehri, Soroush, Kumar, Kundan, Santos, Joao~Felipe, Kastner,
...
22. Theis, Lucas, Oord, A{\"a}ron van~den, and Bethge, Matthias.
...
23. van~den Oord, A{\"a}ron, Dieleman, Sander, Zen, Heiga, Simonyan, Karen,
...
25. Yao, Kaisheng and Zweig, Geoffrey.
...
26. Zen, Heiga and Sak, Ha{\c{s}}im.
...
27. Zen, Heiga, Senior, Andrew, and Schuster, Mike.
