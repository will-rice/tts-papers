...
arxiv_id: "2402.16380"
title:
  An Automated End-to-End Open-Source Software for High-Quality Text-to-Speech
  Dataset Generation
authors:
  - Ahmet Gunduz et.al.
...
- Javadi et al. (2024) Golara Javadi, Kamer Ali Yuksel, Yunsu Kim, Thiago Castro Ferreira, and Mohamed Al-Badrashiny. 2024. [Word-level asr quality estimation for efficient corpus sampling and post-editing through analyzing attentions of a reference-free metric](https://doi.org/10.48550/arXiv.2401.11268). In _IEEE International Conference on Acoustics, Speech, and Signal Processing, ICASSP 2024, Seoul, Korea, April 14-19, 2024_.
...
- Prenger et al. (2019) Ryan Prenger, Rafael Valle, and Bryan Catanzaro. 2019. Waveglow: A flow-based generative network for speech synthesis. In _IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pages 3617–3621. IEEE.
- Rezende and Mohamed (2015) Danilo Rezende and Shakir Mohamed. 2015. Variational inference with normalizing flows. In _International conference on machine learning_. PMLR.
- Wang et al. (2017) Yuxuan Wang, RJ Skerry-Ryan, Daisy Stanton, Yonghui Wu, Ron J Weiss, Navdeep Jaitly, Zongheng Yang, Ying Xiao, Zhifeng Chen, Samy Bengio, Quoc Le, Yannis Agiomyrgiannakis, Rob Clark, and Rif A. Saurous. 2017. Tacotron: Towards end-to-end speech synthesis. _arXiv preprint arXiv:1703.10135_.
- Yuksel et al. (2023a) Kamer Ali Yuksel, Thiago Castro Ferreira, Ahmet Gunduz, Mohamed Al-Badrashiny, and Golara Javadi. 2023a. [A reference-less quality metric for automatic speech recognition via contrastive-learning of a multi-language model with self-supervision](https://doi.org/10.1109/ICASSPW59220.2023.10193003). In _IEEE International Conference on Acoustics, Speech, and Signal Processing, ICASSP 2023, Rhodes Island, Greece, June 4-10, 2023_, pages 1–5. IEEE.
- Yuksel et al. (2023b) Kamer Ali Yuksel, Thiago Castro Ferreira, Golara Javadi, Mohamed Al-Badrashiny, and Ahmet Gunduz. 2023b. [Norefer: a referenceless quality metric for automatic speech recognition via semi-supervised language model fine-tuning with contrastive learning](https://doi.org/10.21437/Interspeech.2023-643). In _Proc. INTERSPEECH 2023_, pages 466–470.
- Yuksel et al. (2022) Kamer Ali Yuksel, Ahmet Gunduz, Shreyas Sharma, and Hassan Sawaf. 2022. [Efficient machine translation corpus generation](https://aclanthology.org/2022.amta-coco4mt.2). In _Proceedings of the 15th biennial conference of the Association for Machine Translation in the Americas_. AMTA.
- Zhang et al. (2023) Chaoning Zhang, Chenshuang Zhang, Sheng Zheng, Yu Qiao, Chenghao Li, Mengchun Zhang, Sumit Kumar Dam, Chu Myaet Thwal, Ye Lin Tun, Le Luang Huy, Donguk kim, Sung-Ho Bae, Lik-Hang Lee, Yang Yang, Heng Tao Shen, In So Kweon, and Choong Seon Hong. 2023. A complete survey on generative ai (aigc): Is chatgpt from gpt-4 to gpt-5 all you need? _arXiv preprint arXiv:2303.11717_.
