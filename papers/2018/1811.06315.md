...
1.  1.
    Can a multi-speaker model with limited data per speaker achieve similar quality than a SPSS guided unit selection with a large database?
2.  2.
...
5.  5.
    Does mixing speakers affects the speaker similarity?
...
- \[18\] J. Lorenzo-Trueba, T. Drugman, J. Latorre, R. Barra-Chicote, T. Merritt, B. Putrycz, S. Ronanki, and K. , Viacheslav, “Robust universal neural vocoding,” in *Submitted to ICASSP 2019*, 2019.
