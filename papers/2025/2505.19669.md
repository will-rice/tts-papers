...
arxiv_id: "2505.19669"
title:
  Zero-Shot Streaming Text to Speech Synthesis with Transducer and Auto-Regressive
  Modeling
authors:
  - Haiyang Sun et.al.
...
2.  2.  We introduce a novel “Delete $`\langle{Bos}\rangle`$ Mechanism” (DBM) for SMLLE. This mechanism allows the model to access necesssary future text introducing as minimal delay as possible, thereby improving the quality of speech reconstruction.
