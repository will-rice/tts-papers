---
arxiv_id: '2508.10412'
title: Facilitating Personalized TTS for Dysarthric Speakers Using Knowledge Anchoring
...
## References
- \[1\] D. Mulfari, G. Meoni, M. Marini, and L. Fanucci, \`\`Machine learning assistive application for users with speech disorders,'' in *Applied Soft Computing*, 2021.
...
- \[4\] J. Mertl, E. Z̆ác̆ková, and B. R̆epová, \`\`Quality of life of patients after total laryngectomy: the struggle against stigmatization and social exclusion using speech synthesis,'' in *Disabil Rehabil Assist Technol.*, 2018.
- \[5\] S. Leivaditi, T. Matsushima, M. Coler, S. Nayak, and V. Verkhodanova, \`\`Fine-Tuning Strategies for Dutch Dysarthric Speech Recognition: Evaluating the Impact of Healthy, Disease-Specific, and Speaker-Specific Data,'' in *Interspeech*, 2024.
...
- \[20\] K. Ito and L. Johnson, \`\`The LJ Speech Dataset,'' in *[https://keithito.com/LJ-Speech-Dataset/](https://keithito.com/LJ-Speech-Dataset/)*, 2017.
...
- \[25\] E. Casanova, J. Weber, C. Shulby, A. C. Junior, E. G'́olge, and M. A. Ponti, \`\`YourTTS: Towards Zero-Shot Multi-Speaker TTS and Zero-Shot Voice Conversion for Everyone,'' in *Proceedings of Machine Learning Research*, 2022.
