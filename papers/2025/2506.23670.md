...
1.  1.
    A layer-aligned distillation framework for expressive end-to-end speech generation, enhanced by teacher fine-tuning to reduce domain shift.
2.  2.
    Three efficient models: Base-Speech, Expressive-Speech, and Expressive-Interleaved, covering audio-only and multimodal speech–text inputs.
3.  3.
    Open-source training and evaluation tools that enable reproducibility and deployment on commodity hardware.
...
- \[3\]  S. Gandhi, P. von Platen, and A. M. Rush, “Distil-whisper: Robust knowledge distillation via large-scale pseudo labelling,” *arXiv preprint*, arXiv:2311.00430, 2023.
...
- \[7\]  Z. Jiang, J. Liu, Y. Ren, J. He, Z. Ye, S. Ji, *et al.*, “Mega-tts 2: Boosting prompting mechanisms for zero-shot speech synthesis,” in *Proc. ICLR*, 2024.
...
- \[11\]  K. Lakhotia *et al.*, “On generative spoken language modeling from raw audio,” *Trans. Assoc. Comput. Linguistics*, vol. 9, pp. 1336–1354, 2021.
