...
System Configuration: Our system is built upon MetaGPT hong2023metagpt with Deepseek-V3 liu2024deepseek as the base LLM, with the model temperature set to 1.3, max_token set to 8192, $`I_{max}`$ set to 3, and the prompting strategy using 0-shot prompting. All used prompts are open-sourced on GitHub.
