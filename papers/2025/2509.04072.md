...
- 2.
  Using the remaining quotations, we include all utterance that have an extracted verb that fall into a predefined list of speech verbs, $`\mathbf{S}`$.
- 3.
  We discard every other quotations.
