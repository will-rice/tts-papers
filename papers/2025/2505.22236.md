---
arxiv_id: '2505.22236'
title: 'A Linguistically Motivated Analysis of Intonational Phrasing in Text-to-Speech
...
1.  1.
    Early closure: When Roger left$`{}_{\text{A}}`$ the house was dark.
2.  2.
    Late closure: When Roger left the house$`{}_{\text{B}}`$ it was dark.
...
1.  1.
    High attachment: The boy looked at the painting$`{}_{\text{A}}`$ with much enthusiasm.
2.  2.
    Low attachment: The boy looked at the painting with muted colours.$`{}_{\text{B}}`$
...
1.  1.
    Comma cue + Syntactic cue: Most links are blue,$`{}_{\text{A}}`$ but they can be any color.
2.  2.
    Syntactic cue: Most links are blue$`{}_{\text{A}}`$ but they can be any color.
...
1.  3.
    Unnatural comma cue: Most links are blue but they can,$`{}_{\text{B}}`$ be any color.
2.  4.
    No cue: Most links are blue but they can$`{}_{\text{B}}`$ be any color.
