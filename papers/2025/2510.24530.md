...
1.  1.
    qu’il est possible de mettre au point un système d’étiquetage lexical qui affecte une étiquette unique à chaque mot sans aucune erreur ;
2.  2.
    ou que le fait d’attribuer à un mot dans un texte une seule étiquette fausse n’est pas un défaut sérieux d’un système d’étiquetage lexical.
...
1.  1.
    la portion est conforme à la fois à une séquence d’entrée et à une séquence de sortie associées par le transducteur.
2.  2.
    la portion est réduite à une seule étiquette grammaticale complète, peu importe laquelle, mais le texte qui commence à ce mot n’apparaît dans aucune séquence d’entrée du transducteur.
...
1.  1.
    la portion est conforme à la fois à une séquence d’entrée et à une séquence de sortie associées par le transducteur.
2.  2.
    la portion est réduite à une seule étiquette grammaticale complète, peu importe laquelle, mais le texte qui commence à ce mot n’admet aucun étiquetage grammatical qui corresponde à une séquence d’entrée du transducteur.
...
1.  1.
    la portion est conforme à une séquence de sortie $`v`$ du transducteur ; la portion est équivalente à une séquence grammaticale complète conforme à une séquence d’entrée $`u`$ associée à $`v`$ par le transducteur.
2.  2.
    la portion est réduite à une seule étiquette grammaticale complète, peu importe laquelle, mais le texte qui commence à ce mot n’admet aucun étiquetage grammatical qui corresponde à une séquence d’entrée du transducteur.
