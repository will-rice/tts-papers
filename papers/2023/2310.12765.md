...
1.  1.
    first energy-based text-to-speech model;
2.  2.
    a range of methods for generating effective negative samples to use in NCE and elsewhere;
3.  3.
    link between diffusion models and energy-based models.
