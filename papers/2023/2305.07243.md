...
2.  2.  DDPMs operate in the continuous domain which allows them to model expressive modalities.
...
1.  1.  Algorithm: DDIM(Song et al.,, 2022)
2.  2.  Schedule: Linear
3.  3.  Sampling steps: 64
4.  4.  Conditioning-Free Guidance constant: 2
...
5.  5.  Diffusion decoder architecture. The diffusion decoder is an attentional network that omits Feedforward blocks. In retrosepct, this was a poor design decision and feed-forward blocks should be included.
