...
## References
- Anderson et al. (2016) Anderson, P.; Fernando, B.; Johnson, M.; and Gould, S. 2016. Spice: Semantic propositional image caption evaluation. In *Computer Vision–ECCV 2016: 14th European Conference, Amsterdam, The Netherlands, October 11-14, 2016, Proceedings, Part V 14*, 382–398. Springer.
...
- Bilen et al. (2020) Bilen, Ç.; Ferroni, G.; Tuveri, F.; Azcarreta, J.; and Krstulović, S. 2020. A framework for the robust evaluation of sound event detection. In *ICASSP 2020-2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, 61–65. IEEE.
...
- Chattopadhyay et al. (2020) Chattopadhyay, S.; Dey, A.; Basak, H.; et al. 2020. Optimizing speech emotion recognition using manta-ray based feature selection. *arXiv preprint arXiv:2009.08909*.
- Chen et al. (2020) Chen, K.; Wu, Y.; Wang, Z.; Zhang, X.; Nian, F.; Li, S.; and Shao, X. 2020. Audio Captioning Based on Transformer and Pre-Trained CNN. In *DCASE*, 21–25.
...
- Cui, Yang, and Yao (2023) Cui, Y.; Yang, Z.; and Yao, X. 2023. Efficient and effective text encoding for chinese llama and alpaca. *arXiv preprint arXiv:2304.08177*.
- Dahake, Shaw et al. (2016) Dahake, P. P.; Shaw, K.; et al. 2016. Speaker dependent speech emotion recognition using MFCC and Support Vector Machine. In *2016 International Conference on Automatic Control and Dynamic Optimization Techniques (ICACDOT)*, 1080–1084.
...
- El Ayadi, Kamel et al. (2011) El Ayadi, M.; Kamel, M. S.; et al. 2011. Survey on speech emotion recognition: Features, classification schemes, and databases. *Pattern recognition*, 44(3): 572–587.
- Guzhov et al. (2022) Guzhov, A.; Raue, F.; Hees, J.; and Dengel, A. 2022. Audioclip: Extending clip to image, text and audio. In *ICASSP 2022-2022 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, 976–980. IEEE.
- Han et al. (2021) Han, Q.; Yuan, W.; Liu, D.; Li, X.; and Yang, Z. 2021. Automated Audio Captioning with Weakly Supervised Pre-Training and Word Selection Methods. In *DCASE*, 6–10.
...
- Huang et al. (2023) Huang, R.; Li, M.; Yang, D.; Shi, J.; Chang, X.; Ye, Z.; Wu, Y.; Hong, Z.; Huang, J.; Liu, J.; et al. 2023. Audiogpt: Understanding and generating speech, music, sound, and talking head. *arXiv preprint arXiv:2304.12995*.
- Jiang et al. (2019) Jiang, P.; Fu, H.; Tao, H.; Lei, P.; and Zhao, L. 2019. Parallelized convolutional recurrent neural network with spectral features for speech emotion recognition. *IEEE Access*, 7: 90368–90377.
...
- Koh, Fuzhao, and Siong (2022) Koh, A.; Fuzhao, X.; and Siong, C. E. 2022. Automated audio captioning using transfer learning and reconstruction latent space similarity regularization. In *ICASSP 2022-2022 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, 7722–7726. IEEE.
...
- Liu et al. (2018) Liu, Z.-T.; Xie, Q.; Wu, M.; Cao, W.-H.; Mei, Y.; and Mao, J.-W. 2018. Speech emotion recognition based on an improved brain emotion learning model. *Neurocomputing*, 309: 145–156.
...
- Mohamed and Aly (2021) Mohamed, O.; and Aly, S. A. 2021. Arabic speech emotion recognition employing wav2vec2. 0 and hubert based on baved dataset. *arXiv preprint arXiv:2110.04425*.
- Nwe, Foo, and De Silva (2003) Nwe, T. L.; Foo, S. W.; and De Silva, L. C. 2003. Speech emotion recognition using hidden Markov models. *Speech communication*, 41(4): 603–623.
...
- Singhal et al. (2023) Singhal, K.; Azizi, S.; Tu, T.; Mahdavi, S. S.; Wei, J.; Chung, H. W.; Scales, N.; Tanwani, A.; Cole-Lewis, H.; Pfohl, S.; et al. 2023. Large language models encode clinical knowledge. *Nature*, 1–9.
...
- Wang and Chan (2019) Wang, Q.; and Chan, A. B. 2019. Describing like humans: on diversity in image captioning. In *Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition*, 4195–4203.
...
- Xu, Wu, and Yu (2022) Xu, X.; Wu, M.; and Yu, K. 2022. A comprehensive survey of automated audio captioning. *arXiv preprint arXiv:2205.05357*.
- Xu et al. (2017) Xu, Y.; Huang, Q.; Wang, W.; Foster, P.; Sigtia, S.; Jackson, P. J.; and Plumbley, M. D. 2017. Unsupervised feature learning based on deep models for environmental audio tagging. *IEEE/ACM Transactions on Audio, Speech, and Language Processing*, 25(6): 1230–1241.
...
- Zhang et al. (2022) Zhang, B.; Lv, H.; Guo, P.; Shao, Q.; Yang, C.; Xie, L.; Xu, X.; Bu, H.; Chen, X.; Zeng, C.; et al. 2022. Wenetspeech: A 10000+ hours multi-domain mandarin corpus for speech recognition. In *ICASSP 2022-2022 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, 6182–6186. IEEE.
