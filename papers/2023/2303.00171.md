...
- •
  If two vectors are similar then the distance metric D(.) is smaller than an upper bound u_(bound), and;
- •
  If two vectors are dissimilar then the distance metric D(.) is greater than a lower bound l_(bound).
...
- \[5\] K. Azizah, M. Adriani, and W. Jatmiko, \`\`Hierarchical transfer learning for multilingual, multi-speaker, and style transfer dnn-based tts on low-resource languages,'' *IEEE Access*, vol. 8, pp. 179 798–179 812, 2020.
...
- \[12\] W.-K. Leung, X. Liu, and H. Meng, \`\`Cnn-rnn-ctc based end-to-end mispronunciation detection and diagnosis,'' in *ICASSP 2019 - 2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, 2019, pp. 8132–8136.
...
- \[16\] J. V. Davis, B. Kulis, P. Jain, S. Sra, and I. S. Dhillon, \`\`Information-theoretic metric learning,'' *ICML '07: Proceedings of the 24th international conference on Machine learning*, 2007. \[Online\]. Available: [https://dl.acm.org/doi/10.1145/1273496.1273523](https://dl.acm.org/doi/10.1145/1273496.1273523)
