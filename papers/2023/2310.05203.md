...
arxiv_id: "2310.05203"
title:
  "A Comparative Study of Voice Conversion Models with Large-Scale Speech and
...
- \[1\] Xin Chen, Wei Chu, Jinxi Guo and Ning Xu “Singing voice conversion with non-parallel data” In _Proc. MIPR_, 2019, pp. 292–296
- \[2\] Adam Polyak, Lior Wolf, Yossi Adi and Yaniv Taigman “Unsupervised Cross-Domain Singing Voice Conversion” In _Proc. Interspeech_, 2020, pp. 801–805
- \[3\] Songxiang Liu et al. “FastSVC: Fast cross-domain singing voice conversion with feature-wise linear modulation” In _Proc. ICME_, 2021, pp. 1–6
- \[4\] Chao Wang et al. “Towards high-fidelity singing voice conversion with acoustic reference and contrastive predictive coding” In _Proc. Interspeech_, 2022, pp. 4287–4291
- \[5\] Tejas Jayashankar et al. “Self-Supervised Representations for Singing Voice Conversion” In _Proc. ICASSP_, 2023, pp. 1–5
- \[6\] Jaime Lorenzo-Trueba et al. “The voice conversion challenge 2018: Promoting development of parallel and nonparallel methods” In _Proc. Odyssey_, 2018, pp. 195–202
- \[7\] Yi Zhao et al. “Voice conversion challenge 2020: Intra-lingual semi-parallel and cross-lingual voice conversion” In _Proc. Joint Workshop for the BC and VCC_, 2020, pp. 80–98
- \[8\] Yu Wang et al. “Opencpop: A High-Quality Open Source Chinese Popular Song Corpus for Singing Voice Synthesis” In _Proc. Interspeech_, 2022, pp. 4242–4246
- \[9\] Lichao Zhang et al. “M4Singer: A Multi-Style, Multi-Singer and Musical Score Provided Mandarin Singing Corpus” In _Proc. NeurIPS_ 35, 2022, pp. 6914–6926
- \[10\] Itsuki Ogawa and Masanori Morise “Tohoku Kiritan singing database: A singing database for statistical parametric singing synthesis using Japanese pop songs” In _Acoustical Science and Technology_ 42.3, 2021, pp. 140–145
- \[11\] Hiroki Tamaru, Shinnosuke Takamichi, Naoko Tanji and Hiroshi Saruwatari “JVS-MuSiC: Japanese multispeaker singing-voice corpus” In _arXiv preprint arXiv:2001.07044_, 2020
- \[12\] Zhiyan Duan et al. “The NUS sung and spoken lyrics corpus: A quantitative comparison of singing and speech” In _Proc. APSIPA ASC_, 2013, pp. 1–9
- \[13\] Junya Koguchi, Shinnosuke Takamichi and Masanori Morise “PJS: Phoneme-balanced Japanese singing-voice corpus” In _Proc. APSIPA ASC_, 2020, pp. 487–491
- \[14\] Bidisha Sharma et al. “NHSS: A speech and singing parallel database” In _Speech Communication_ 133, 2021, pp. 9–22
- \[15\] Rongjie Huang et al. “Multi-singer: Fast multi-singer singing voice vocoder with a large-scale corpus” In _Proc. ACM ICM_, 2021, pp. 3945–3954
- \[16\] Vassil Panayotov, Guoguo Chen, Daniel Povey and Sanjeev Khudanpur “LibriSpeech: an ASR corpus based on public domain audio books” In _Proc. ICASSP_, 2015, pp. 5206–5210
- \[17\] Wen-Chin Huang et al. “The Singing Voice Conversion Challenge 2023” In _arXiv preprint arXiv:2306.14422_, 2023
- \[18\] Kaizhi Qian et al. “CONTENTVEC: An improved self-supervised speech representation by disentangling speakers” In _Proc. ICML_, 2022, pp. 18003–18017
- \[19\] Benjamin Niekerk and et al. Carbonneau “A comparison of discrete and soft speech units for improved voice conversion” In _Proc. ICASSP_, 2022, pp. 6562–6566
- \[20\] Wen-Chin Huang, Shu-Wen Yang, Tomoki Hayashi and Tomoki Toda “A comparative study of self-supervised speech representation based voice conversion” In _IEEE Journal of Selected Topics in Signal Processing_ 16.6, 2022, pp. 1308–1318
- \[21\] Jonathan Ho, Ajay Jain and Pieter Abbeel “Denoising diffusion probabilistic models” In _Proc. NeurIPS_ 33, 2020, pp. 6840–6851
- \[22\] Songxiang Liu, Yuewen Cao, Dan Su and Helen Meng “DiffSVC: A diffusion probabilistic model for singing voice conversion” In _Proc. ASRU_, 2021, pp. 741–748
- \[23\] Hyeong-Seok Choi et al. “Neural analysis and synthesis: Reconstructing speech from self-supervised representations” In _Proc. NeurIPS_ 34, 2021, pp. 16251–16265
- \[24\] Reo Yoneyama, Yi-Chiao Wu and Tomoki Toda “Source-Filter HiFi-GAN: Fast and Pitch Controllable High-Fidelity Neural Vocoder” In _Proc. ICASSP_, 2023, pp. 1–5
- \[25\] Wei-Ning Hsu et al. “HuBERT: Self-supervised speech representation learning by masked prediction of hidden units” In _IEEE/ACM Trans. on Audio, Speech, and Lang. Process._ 29, 2021, pp. 3451–3460
- \[26\] Masanori Morise “Harvest: A high-performance fundamental frequency estimator from speech signals” In _Proc. Interspeech_, 2017, pp. 2321–2325
- \[27\] Masanori Morise “D4C, a band-aperiodicity estimator for high-quality speech synthesis” In _Speech Communication_ 84, 2016, pp. 57–65
- \[28\] RJ Skerry-Ryan et al. “Towards end-to-end prosody transfer for expressive speech synthesis with Tacotron” In _Proc. ICML_, 2018, pp. 4693–4702
- \[29\] Yuxuan Wang et al. “Style tokens: Unsupervised style modeling, control and transfer in end-to-end speech synthesis” In _Proc. ICML_, 2018, pp. 5180–5189
- \[30\] Mingjian Chen et al. “Adaspeech: Adaptive text to speech for custom voice” In _Proc. ICLR_, 2021
- \[31\] Jonathan Ho and Tim Salimans “Classifier-free diffusion guidance” In _Proc. NeurIPS_, 2021
- \[32\] Sungwon Kim, Heeseung Kim and Sungroh Yoon “Guided-TTS 2: A diffusion model for high-quality adaptive text-to-speech with untranscribed data” In _arXiv preprint arXiv:2205.15370_, 2022
- \[33\] Hubert Siuzdak, Piotr Dura, Pol van Rijn and Nori Jacoby “WavThruVec: Latent speech representation as intermediate features for neural speech synthesis” In _Proc. Interspeech_, 2022, pp. 833–837
- \[34\] Hyeong-Seok Choi, Jinhyeok Yang, Juheon Lee and Hyeongju Kim “NANSY++: Unified Voice Synthesis with Neural Analysis and Synthesis” In _Proc. ICLR_, 2022
...
- \[36\] Christophe Veaux, Junichi Yamagishi and Kirsten MacDonald “CSTR VCTK corpus: English multi-speaker corpus for CSTR voice cloning toolkit” In _University of Edinburgh. The Centre for Speech Technology Research (CSTR)_, 2017 DOI: [10.7488/ds/2645](https://dx.doi.org/10.7488/ds/2645)
- \[37\] Heiga Zen et al. “LibriTTS: A Corpus Derived from LibriSpeech for Text-to-Speech” In _Proc. Interspeech_, 2019, pp. 1526–1530
- \[38\] Jinglin Liu et al. “DiffSinger: Singing voice synthesis via shallow diffusion mechanism” In _AAAI_ 36.10, 2022, pp. 11020–11028
- \[39\] Soonbeom Choi et al. “Children’s song dataset for singing voice research” In _Proc. ISMIR_, 2020
...
- \[41\] Ryosuke Sonobe, Shinnosuke Takamichi and Hiroshi Saruwatari “JSUT corpus: free large-scale Japanese speech corpus for end-to-end speech synthesis” In _arXiv preprint arXiv:1711.00354_, 2017
- \[42\] Ilya Loshchilov and Frank Hutter “Decoupled weight decay regularization” In _Proc. ICLR_, 2019
- \[43\] Sang-gil Lee et al. “BigVGAN: A universal neural vocoder with large-scale training” In _Proc. ICLR_, 2023
- \[44\] Diederik P Kingma and Jimmy Ba “Adam: A method for stochastic optimization” In _Proc. ICLR_, 2015
- \[45\] Takaaki Saeki et al. “UTMOS: UTokyo-SaruLab System for VoiceMOS Challenge 2022” In _Proc. Interspeech_, 2022, pp. 4521–4525
- \[46\] Sanyuan Chen et al. “WavLM: Large-scale self-supervised pre-training for full stack speech processing” In _IEEE Journal of Selected Topics in Signal Processing_ 16.6, 2022, pp. 1505–1518
- \[47\] Alec Radford et al. “Robust Speech Recognition via Large-Scale Weak Supervision” In _Proc. ICML_ 202, 2023, pp. 28492–28518
