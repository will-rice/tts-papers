---
arxiv_id: '2203.10637'
title: Vocal effort modeling in neural TTS for improving the intelligibility of synthetic
  speech in noise
authors:
- Tuomo Raitio
- Petko Petkov
...
- 1.
  Baseline: Synthetic speech without modification \[22\].
- 2.
  Proposed: Synthetic speech with increased vocal effort.
- 3.
  SS: Baseline processed with spectral shaping (SS) \[14\].
- 4.
  SSDRC: Baseline processed with spectral shaping and dynamic range compression (SSDRC) \[14\].
...
## References
- \[1\] M. Cooke, C. Mayo, and C. Valentini-Botinhao, “Intelligibility-enhancing speech modifications: The Hurricane Challenge,” in *Interspeech*, 2013.
...
- \[8\] H. Traunmüller and A. Eriksson, “Acoustic effects of variation in vocal effort by men, women, and children,” *J. Acoust. Soc. Am.*, vol. 107, no. 6, pp. 3438–3451, 2000.
...
- \[10\] C. Gobl and A. Ní Chasaide, “The role of voice quality in communicating emotion, mood and attitude,” *Speech Comm.*, vol. 40, no. 1–2, pp. 189–212, 2003.
...
- \[14\] T.-C. Zorilă, V. Kandia, and Y. Stylianou, “Speech-in-noise intelligibility improvement based on spectral shaping and dynamic range compression,” in *Interspeech*, 2012.
...
- \[16\] T. Raitio, A. Suni, M. Vainio, and P. Alku, “Analysis of HMM-based Lombard speech synthesis,” in *Interspeech*, 2011.
...
- \[25\] W. V. Summers, D. Pisoni, R. Bernacki, R. Pedlow, and M. Stokes, “Effects of noise on speech production: Acoustic and perceptual analyses,” *J. Acoust. Soc. Am.*, vol. 84, no. 3, pp. 917–928, 1988.
- \[26\] E. Godoy, M. Koutsogiannaki, and Y. Stylianou, “Approaching speech intelligibility enhancement with inspiration from Lombard and clear speaking styles,” *Computer Speech & Language*, vol. 28, no. 2, pp. 629–647, 2014.
- \[27\] D. O’Shaughnessy, *Speech communications: Human and Machine, 2nd Edition*.   IEEE, 2000.
- \[28\] C. V. Botinhao, J. Yamagishi, S. King, and R. Maia, “Intelligibility enhancement of HMM-generated speech in additive noise by modifying Mel cepstral coefficients to increase the Glimpse Proportion,” *Computer Speech & Language*, vol. 28, no. 2, pp. 665–686, 2013.
- \[29\] P. N. Petkov and W. B. Kleijn, “Spectral dynamics recovery for enhanced speech intelligibility in noise,” *IEEE Trans. Audio Speech Lang. Proc.*, vol. 23, no. 2, pp. 327–338, 2015.
- \[30\] C. Chermaz and S. King, “A sound engineering approach to near end listening enhancement,” in *Interspeech*, 2020.
- \[31\] M. Cooke, C. Mayo, C. V. Botinhao, Y. Stylianou, B. Sauert, and Y. Tang, “Evaluating the intelligibility benefit of speech modifications in known noise conditions,” *Speech Comm.*, vol. 55, pp. 572–585, 2013.
- \[32\] P. S. Chanda and S. Park, “Speech intelligibility enhancement using tunable equalization filter,” in *ICASSP*, 2007.
- \[33\] B. Sauert and P. Vary, “Near end listening enhancement optimized with respect to speech intelligibility index and audio power limitations,” in *Proc. Europ. Sig. Proc. Conf.*, 2010, pp. 1919–1923.
- \[34\] C. Taal, J. Jensen, and A. Leijon, “On optimal linear filtering of speech for near-end listening enhancement,” *IEEE Sig. Proc. Letters*, vol. 20, no. 3, pp. 225–228, 2013.
- \[35\] D. Paul, M. P. Shifas, Y. Pantazis, and Y. Stylianou, “Enhancing speech intelligibility in text-to-speech synthesis using speaking style conversion,” in *Interspeech*, 2020.
- \[36\] G. Li, R. Hu, S. Ke, R. Zhang, X. Wang, and L. Gao, “Speech intelligibility enhancement using non-parallel speaking style conversion with StarGAN and dynamic range compression,” in *ICME*, 2020, pp. 1–6.
- \[37\] J. Shen, R. Pang, R. J. Weiss, M. Schuster, N. Jaitly, Z. Yang, Z. Chen, Y. Zhang, Y. Wang, R. Skerry-Ryan, R. A. Saurous, Y. Agiomyrgiannakis, and Y. Wu, “Natural TTS synthesis by conditioning WaveNet on Mel spectrogram predictions,” in *ICASSP*, 2017.
- \[38\] W. Ping, K. Peng, A. Gibiansky, S. O. Arik, A. Kannan, S. Narang, J. Raiman, and J. Miller, “Deep Voice 3: 2000-speaker neural text-to-speech,” in *ICLR*, 2018.
- \[39\] Y. Ren, C. Hu, X. Tan, T. Qin, S. Zhao, Z. Zhao, and T. Liu, “FastSpeech 2: Fast and high-quality end-to-end text to speech,” *arXiv:2006.04558*, 2020.
- \[40\] A. van den Oord, S. Dieleman, H. Zen, K. Simonyan, O. Vinyals, A. Graves, N. Kalchbrenner, A. Senior, and K. Kavukcuoglu, “Wavenet: A generative model for raw audio,” in *SSW9*, 2016.
- \[41\] N. Kalchbrenner, E. Elsen, K. Simonyan, S. Noury, N. Casagrande, E. Lockhart, F. Stimberg, A. van den Oord, S. Dieleman, and K. Kavukcuoglu, “Efficient neural audio synthesis,” *arXiv:1802.08435*, 2018.
- \[42\] IEEE Subcommittee on Subjective Measurements, “IEEE recommended practices for speech quality measurements,” *IEEE Transactions on Audio and Electroacoustics*, vol. 17, pp. 227–46, 1969.
- \[43\] S. Achanta, A. Antony, L. Golipour, J. Li, T. Raitio, R. Rasipuram, F. Rossi, J. Shi, J. Upadhyay, D. Winarsky, and H. Zhang, “On-device neural speech synthesis,” in *ASRU*, 2021.
- \[44\] ITU-T, “Objective measurement of active speech level,” Recommendation P.56, 1993.
- \[45\] D. Bates, M. Mächler, B. Bolker, and S. Walker, “Fitting linear mixed-effects models using lme4,” *Journal of Statistical Software*, vol. 67, no. 1, pp. 1–48, 2015.
- \[46\] R. V. Lenth, *emmeans: Estimated marginal means, aka least-squares means*, 2022, R package version 1.7.2.
