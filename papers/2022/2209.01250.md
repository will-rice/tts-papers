---
arxiv_id: '2209.01250'
title: Improving Contextual Recognition of Rare Words with an Alternate Spelling Prediction
  Model
authors:
...
1.  1.
    For Windows users, the bullzip printer can convert any PDF to have embedded and subsetted fonts.
2.  2.
    For Linux/Mac users, you may use \
    pdftops file.pdf\
...
Final page numbers will be added later to the document electronically. *Do not make any footers or headers!*
