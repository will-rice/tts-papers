---
arxiv_id: '2203.14416'
title: 'Bunched LPCNet2: Efficient Neural Vocoders Covering Devices from Cloud to
  Edge'
authors:
- Sangjun Park
- Kihyun Choo
...
1.  1.
    Single logistic output layer that extends the coverage of Bunched LPCNet to low-resource constraints.
2.  2.
    Dual-rate LPCNet for computational and maintenance cost reduction.
3.  3.
    Insightful tricks that significantly reduce the model footprint.
...
- \[19\] N. Ellinas, G. Vamvoukakis, K. Markopoulos, A. Chalamandaris, G. Maniati, P. Kakoulidis, S. Raptis, J. S. Sung, H. Park, and P. Tsiakoulis, “High quality streaming speech synthesis with low, sentence-length-independent latency,” in *Proc. of INTERSPEECH*, 2020, pp. 2022–2026.
