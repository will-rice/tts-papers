...
1.  1.  Reproducibility for all papers
    - •
...
2.  2.  Data sets - for all data sets used, the paper includes information about the following:
    - •
...
4.  4.  For all experiments with hyperparameter search - you have included
    - •
...
5.  5.  Reported experimental results - your paper includes:
    - •
