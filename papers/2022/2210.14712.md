---
arxiv_id: '2210.14712'
title: 'Bloom Library: Multimodal Datasets in 300+ Languages for a Variety of Downstream
  Tasks'
authors:
- Colin Leong
- Joshua Nemecek
...
- Barrault et al. (2018) Loïc Barrault, Fethi Bougares, Lucia Specia, Chiraag Lala, Desmond Elliott, and Stella Frank. 2018. Findings of the third shared task on multimodal machine translation. In *Proceedings of the Third Conference on Machine Translation: Shared Task Papers*, pages 304–323.
- Bird (2020) Steven Bird. 2020. [Decolonising speech and language technology](https://doi.org/10.18653/v1/2020.coling-main.313). In *Proceedings of the 28th International Conference on Computational Linguistics*, pages 3504–3519, Barcelona, Spain (Online). International Committee on Computational Linguistics.
- Bird (2022) Steven Bird. 2022. [Local languages, third spaces, and other high-resource scenarios](https://doi.org/10.18653/v1/2022.acl-long.539). In *Proceedings of the 60th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, pages 7817–7829, Dublin, Ireland. Association for Computational Linguistics.
- Black (2019) Alan W Black. 2019. [Cmu wilderness multilingual speech dataset](https://doi.org/10.1109/ICASSP.2019.8683536). In *ICASSP 2019 - 2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 5971–5975.
- Blasi et al. (2021) Damián E. Blasi, Antonios Anastasopoulos, and Graham Neubig. 2021. Systematic inequalities in language technology performance across the world’s languages. *ArXiv*, abs/2110.06733.
...
- Eberhard et al. (2021) David M. Eberhard, Gary F. Simons, and Charles D. Fennig. 2021. [*Ethnologue: Languages of the World*](http://www.ethnologue.com), twenty-fourth edition. SIL International, Dallas, Texas.
- Elliott et al. (2017) Desmond Elliott, Stella Frank, Loïc Barrault, Fethi Bougares, and Lucia Specia. 2017. [Findings of the second shared task on multimodal machine translation and multilingual image description](http://www.aclweb.org/anthology/W17-4718). In *Proceedings of the Second Conference on Machine Translation, Volume 2: Shared Task Papers*, pages 215–233, Copenhagen, Denmark. Association for Computational Linguistics.
- Elliott et al. (2016) Desmond Elliott, Stella Frank, Khalil Sima’an, and Lucia Specia. 2016. [Multi30k: Multilingual english-german image descriptions](https://doi.org/10.18653/v1/W16-3210). In *Proceedings of the 5th Workshop on Vision and Language*, pages 70–74. Association for Computational Linguistics.
...
- Lewis and Simons (2016) Melvyn Lewis and Gary Simons. 2016. *Sustaining language use: Perspectives on community-based language development.*
...
- McCarthy et al. (2020) Arya D. McCarthy, Rachel Wicks, Dylan Lewis, Aaron Mueller, Winston Wu, Oliver Adams, Garrett Nicolai, Matt Post, and David Yarowsky. 2020. [The Johns Hopkins University Bible corpus: 1600+ tongues for typological exploration](https://aclanthology.org/2020.lrec-1.352). In *Proceedings of the 12th Language Resources and Evaluation Conference*, pages 2884–2892, Marseille, France. European Language Resources Association.
...
- Szegedy et al. (2016) Christian Szegedy, Vincent Vanhoucke, Sergey Ioffe, Jon Shlens, and Zbigniew Wojna. 2016. [Rethinking the inception architecture for computer vision](https://doi.org/10.1109/CVPR.2016.308). In *2016 IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, pages 2818–2826.
- Voinea (2018) Cristina Voinea. 2018. [Designing for conviviality](https://doi.org/https://doi.org/10.1016/j.techsoc.2017.07.002). *Technology in Society*, 52:70–78. Technology and the Good Society.
...
- Yun et al. (2021) Heeseung Yun, Youngjae Yu, Wonsuk Yang, Kangil Lee, and Gunhee Kim. 2021. Pano-avqa: Grounded audio-visual question answering on 360^(∘) videos. In *ICCV*.
