...
## References
- Abdelali et al. (2016) Ahmed Abdelali, Kareem Darwish, Nadir Durrani, and Hamdy Mubarak. 2016. [Farasa: A fast and furious segmenter for Arabic](https://doi.org/10.18653/v1/N16-3003). In *Proceedings of the 2016 NAACL: Demonstrations*, pages 11–16, San Diego, California. ACL.
- Ali et al. (2019) Ahmed Ali, Suwon Shon, Younes Samih, Hamdy Mubarak, Ahmed Abdelali, James Glass, Steve Renals, and Khalid Choukri. 2019. [The mgb-5 challenge: Recognition and dialect identification of dialectal arabic speech](https://doi.org/10.1109/ASRU46091.2019.9003960). In *2019 IEEE (ASRU)*, pages 1026–1033.
- Ali et al. (2017) Ahmed Ali, Stephan Vogel, and Steve Renals. 2017. [Speech recognition challenge in the wild: Arabic mgb-3](https://doi.org/10.1109/ASRU.2017.8268952). In *2017 IEEE ASRU*, pages 316–322.
...
- Guski (1997) Rainer Guski. 1997. Psychological methods for evaluating sound quality and assessing acoustic information. *Acta Acustica united with Acustica*, 83:765–774.
- Hussein et al. (2022) Amir Hussein, Shinji Watanabe, and Ahmed Ali. 2022. [Arabic speech recognition by end-to-end, modular systems and human](https://doi.org/https://doi.org/10.1016/j.csl.2021.101272). *Computer Speech & Language*, 71:101272.
...
- Li et al. (2019) Naihan Li, Shujie Liu, Yanqing Liu, Sheng Zhao, and Ming Liu. 2019. [Neural speech synthesis with transformer network](https://doi.org/10.1609/aaai.v33i01.33016706). In *Proceedings of the AAAI Conference on Artificial Intelligence*, AAAI’19/IAAI’19/EAAI’19. AAAI Press.
...
- Tahon et al. (2017) Marie Tahon, Gwénolé Lecorvé, Damien Lolive, and Raheel Qader. 2017. [Perception of expressivity in TTS: linguistics, phonetics or prosody?](https://doi.org/10.1007/978-3-319-68456-7_22) In *Statistical Language and Speech Processing*, volume 10583, pages 262–274, Le Mans, France.
...
- Yamamoto et al. (2020) Ryuichi Yamamoto, Eunwoo Song, and Jae-Min Kim. 2020. Parallel wavegan: A fast waveform generation model based on generative adversarial networks with multi-resolution spectrogram. *ICASSP 2020 - 2020 IEEE (ICASSP)*, pages 6199–6203.
- Zhang et al. (2018) Jing-Xuan Zhang, Zhen-Hua Ling, and Li-Rong Dai. 2018. [Forward attention in sequence- to-sequence acoustic modeling for speech synthesis](https://doi.org/10.1109/ICASSP.2018.8462020). In *2018 IEEE ICASSP*, pages 4789–4793.
