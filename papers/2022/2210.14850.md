...
- \[2\] Naihan Li et al. “Neural speech synthesis with Transformer network” In *Proc. AAAI* 33.01, 2019, pp. 6706–6713
- \[3\] Xu Tan et al. “NaturalSpeech: End-to-End Text to Speech Synthesis with Human-Level Quality” In *arXiv:2205.04421*, 2022
- \[4\] Wei Ping et al. “Deep Voice 3: 2000-Speaker Neural Text-to-Speech.” In *ICLR* 79, 2018, pp. 1094–1099
- \[5\] Ye Jia et al. “Transfer learning from speaker verification to multispeaker text-to-speech synthesis” In *Proc. NIPS* 31, 2018
- \[6\] Erica Cooper et al. “Zero-shot multi-speaker text-to-speech with state-of-the-art neural speaker embeddings” In *Proc. ICASSP*, 2020, pp. 6184–6188
...
- \[8\] Ryosuke Sonobe, Shinnosuke Takamichi and Hiroshi Saruwatari “JSUT corpus: free large-scale Japanese speech corpus for end-to-end speech synthesis” In *arXiv:1711.00354*, 2017
- \[9\] Shinnosuke Takamichi et al. “JVS corpus: free Japanese multi-speaker voice corpus” In *arXiv:1908.06248*, 2019
- \[10\] Laurens Van der Maaten and Geoffrey Hinton “Visualizing data using t-SNE” In *Journal of machine learning research* 9.11, 2008
- \[11\] David Snyder et al. “X-vectors: Robust DNN embeddings for speaker recognition” In *Proc. ICASSP*, 2018, pp. 5329–5333
- \[12\] Dimitar Trajanov et al. “Dark data in Internet of things (IoT): challenges and opportunities” In *7th Small Systems Simulation Symposium*, 2018, pp. 1–8
- \[13\] Björn Schembera and Juan M Durán “Dark data as the new challenge for big data science and the introduction of the scientific data officer” In *Philosophy & Technology* 33.1, 2020, pp. 93–115
- \[14\] Heiga Zen et al. “LibriTTS: A Corpus Derived from LibriSpeech for Text-to-Speech” In *Proc. INTERSPEECH*, 2019, pp. 1526–1530
- \[15\] Evelina Bakhturina et al. “Hi-Fi multi-speaker English TTS dataset” In *Proc. INTERSPEECH*, 2021, pp. 2776–2780
- \[16\] Pascal Puchtler, Johannes Wirth and René Peinl “HUI-Audio-Corpus-German: A high quality TTS dataset” In *German Conference on Artificial Intelligence (Künstliche Intelligenz)*, 2021, pp. 204–216
- \[17\] Anthony Rousseau, Paul Deléglise and Yannick Esteve “TED-LIUM: an Automatic Speech Recognition dedicated corpus.” In *Proc. LREC*, 2012, pp. 125–129
- \[18\] Chen Zhang et al. “DenoiSpeech: Denoising text to speech with frame-level noise modeling” In *Proc. ICASSP*, 2021, pp. 7063–7067
- \[19\] Takaaki Saeki, Kentaro Tachibana and Ryuichi Yamamoto “DRSpeech: Degradation-Robust Text-to-Speech Synthesis with Frame-Level and Utterance-Level Acoustic Representation Learning” In *Proc. INTERSPEECH*, 2022, pp. 793–797
- \[20\] Karolos Nikitaras et al. “Fine-grained Noise Control for Multispeaker Speech Synthesis” In *Proc. INTERSPEECH*, 2022, pp. 828–832
- \[21\] Shinnosuke Takamichi et al. “JTubeSpeech: corpus of Japanese speech collected from YouTube for speech recognition and speaker verification” In *arXiv:2112.09323*, 2021
- \[22\] Daniel Galvez et al. “The People’s Speech: A Large-Scale Diverse English Speech Recognition Dataset for Commercial Usage” [https://openreview.net/forum?id=R8CwidgJ0yT](https://openreview.net/forum?id=R8CwidgJ0yT) In *Proc. NeurIPS Datasets and Benchmarks*, 2021
- \[23\] Guoguo Chen et al. “GigaSpeech: An Evolving, Multi-domain ASR Corpus with 10,000 Hours of Transcribed Audio” In *arXiv:2106.06909*, 2021
- \[24\] Sebastian Möller et al. “Comparison of approaches for instrumentally predicting the quality of text-to-speech systems” In *Proc. INTERSPEECH*, 2010, pp. 1325–1328
- \[25\] Brian Patton et al. “AutoMOS: Learning a non-intrusive assessor of naturalness-of-speech” In *Proc. NIPS 2016 End-to-end Learning for Speech and Audio Processing Workshop*, 2016
- \[26\] Wen Chin Huang et al. “The VoiceMOS Challenge 2022” In *Proc. INTERSPEECH*, 2022, pp. 4536–4540
- \[27\] Ludwig Kürzinger et al. “CTC-segmentation of large corpora for German end-to-end speech recognition” In *Proc. SPECOM*, 2020, pp. 267–278
- \[28\] Jennifer Williams and Simon King “Disentangling Style Factors from Speaker Representations.” In *Proc. INTERSPEECH*, 2019, pp. 3945–3949
- \[29\] Tomoki Hayashi et al. “ESPnet-TTS: Extending the edge of TTS research” In *arXiv:2110.07840*, 2022
- \[30\] Ron J Weiss et al. “Wave-Tacotron: Spectrogram-free end-to-end text-to-speech synthesis” In *Proc. ICASSP*, 2021, pp. 5679–5683
- \[31\] Takaaki Saeki et al. “UTMOS: UTokyo-SaruLab System for VoiceMOS Challenge 2022” In *Proc. INTERSPEECH*, 2022, pp. 4521–4525
...
- \[34\] Yi Ren et al. “Fastspeech 2: Fast and high-quality end-to-end text to speech” In *Proc. ICLR*, 2021
...
- \[41\] Gabriel Mittag et al. “NISQA: A deep CNN-self-attention model for multidimensional speech quality prediction with crowdsourced datasets” In *Proc. INTERSPEECH*, 2021, pp. 2127–2131
- \[42\] Alexei Baevski et al. “wav2vec 2.0: A framework for self-supervised learning of speech representations” In *Proc. NeurIPS* 33, 2020, pp. 12449–12460
...
- \[45\] William B March, Parikshit Ram and Alexander G Gray “Fast Euclidean minimum spanning tree: algorithm, analysis, and applications” In *Proc. ACM SIGKDD*, 2010, pp. 603–612
- \[46\] Daisy Stanton et al. “Speaker generation” In *Proc. ICASSP*, 2022, pp. 7897–7901
