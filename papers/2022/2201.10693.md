...
- Mouchtaris _et al._ \[2004\] A. Mouchtaris, J. Van der Spiegel, P. Mueller, A spectral conversion approach to the iterative Wiener filter for speech enhancement, in: IEEE international conference on multimedia and expo (ICME), vol. 3, IEEE, 1971–1974, 2004.
...
- Stylianou _et al._ \[1998\] Y. Stylianou, O. Cappé, E. Moulines, Continuous probabilistic transform for voice conversion, IEEE Transactions on speech and audio processing 6 (2) (1998) 131–142.
- Toda _et al._ \[2007\] T. Toda, A. W. Black, K. Tokuda, Voice conversion based on maximum-likelihood estimation of spectral parameter trajectory, IEEE Transactions on Audio, Speech, and Language Processing 15 (8) (2007) 2222–2235.
- Erro _et al._ \[2009\] D. Erro, A. Moreno, A. Bonafonte, Voice conversion based on weighted frequency warping, IEEE Transactions on Audio, Speech, and Language Processing 18 (5) (2009) 922–931.
- Godoy _et al._ \[2011\] E. Godoy, O. Rosec, T. Chonavel, Voice conversion using dynamic frequency warping with amplitude scaling, for parallel or nonparallel corpora, IEEE Transactions on Audio, Speech, and Language Processing 20 (4) (2011) 1313–1323.
- Tian _et al._ \[2015\] X. Tian, Z. Wu, S. W. Lee, N. Q. Hy, E. S. Chng, M. Dong, Sparse representation for frequency warping based voice conversion, in: 2015 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), IEEE, 4235–4239, 2015.
- Takashima _et al._ \[2012\] R. Takashima, T. Takiguchi, Y. Ariki, Exemplar-based voice conversion in noisy environment, in: 2012 IEEE Spoken Language Technology Workshop (SLT), IEEE, 313–317, 2012.
- Wu _et al._ \[2014\] Z. Wu, T. Virtanen, E. S. Chng, H. Li, Exemplar-based sparse representation with residual compensation for voice conversion, IEEE/ACM Transactions on Audio, Speech, and Language Processing 22 (10) (2014) 1506–1521.
- Tian _et al._ \[2017\] X. Tian, S. W. Lee, Z. Wu, E. S. Chng, H. Li, An exemplar-based approach to frequency warping for voice conversion, IEEE/ACM Transactions on Audio, Speech, and Language Processing 25 (10) (2017) 1863–1876.
- Sun _et al._ \[2015\] L. Sun, S. Kang, K. Li, H. Meng, Voice conversion using deep bidirectional long short-term memory based recurrent neural networks, in: 2015 IEEE international conference on acoustics, speech and signal processing (ICASSP), IEEE, 4869–4873, 2015.
- Hsu _et al._ \[2016\] C.-C. Hsu, H.-T. Hwang, Y.-C. Wu, Y. Tsao, H.-M. Wang, Voice conversion from non-parallel corpora using variational auto-encoder, in: 2016 Asia-Pacific Signal and Information Processing Association Annual Summit and Conference (APSIPA), IEEE, 1–6, 2016.
- Hsu _et al._ \[2017a\] C.-C. Hsu, H.-T. Hwang, Y.-C. Wu, Y. Tsao, H.-M. Wang, Voice conversion from unaligned corpora using variational autoencoding wasserstein generative adversarial networks, arXiv preprint arXiv:1704.00849 .
...
- Kameoka _et al._ \[2018\] H. Kameoka, T. Kaneko, K. Tanaka, N. Hojo, Stargan-vc: Non-parallel many-to-many voice conversion using star generative adversarial networks, in: IEEE Spoken Language Technology Workshop (SLT), IEEE, 266–273, 2018.
- Tanaka _et al._ \[2019\] K. Tanaka, H. Kameoka, T. Kaneko, N. Hojo, AttS2S-VC: Sequence-to-sequence voice conversion with attention and context preservation mechanisms, in: IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), IEEE, 6805–6809, 2019.
- Zhang _et al._ \[2019\] J.-X. Zhang, Z.-H. Ling, L.-J. Liu, Y. Jiang, L.-R. Dai, Sequence-to-sequence acoustic modeling for voice conversion, IEEE/ACM Transactions on Audio, Speech, and Language Processing 27 (3) (2019) 631–644.
- Du _et al._ \[2021\] H. Du, X. Tian, L. Xie, H. Li, Optimizing voice conversion network with cycle consistency loss of speaker identity, in: 2021 IEEE Spoken Language Technology Workshop (SLT), IEEE, 507–513, 2021.
- Wang _et al._ \[2021a\] Z. Wang, X. Zhou, F. Yang, T. Li, H. Du, L. Xie, W. Gan, H. Chen, H. Li, Enriching Source Style Transfer in Recognition-Synthesis based Non-Parallel Voice Conversion, arXiv preprint arXiv:2106.08741 .
...
- Qian _et al._ \[2019\] K. Qian, Y. Zhang, S. Chang, X. Yang, M. Hasegawa-Johnson, Autovc: Zero-shot voice style transfer with only autoencoder loss, in: International Conference on Machine Learning, PMLR, 5210–5219, 2019.
...
- Wang _et al._ \[2021b\] Z. Wang, Q. Xie, T. Li, H. Du, L. Xie, P. Zhu, M. Bi, One-shot Voice Conversion For Style Transfer Based On Speaker Adaptation, arXiv preprint arXiv:2111.12277 .
- Huang _et al._ \[2021\] T.-h. Huang, J.-h. Lin, H.-y. Lee, How Far Are We from Robust Voice Conversion: A Survey, in: 2021 IEEE Spoken Language Technology Workshop (SLT), IEEE, 514–521, 2021.
- Chou _et al._ \[2018\] J.-c. Chou, C.-c. Yeh, H.-y. Lee, L.-s. Lee, Multi-target Voice Conversion without Parallel Data by Adversarially Learning Disentangled Audio Representations, Proc. Interspeech 2018 (2018) 501–505.
- Li _et al._ \[2018\] L. Li, D. Wang, Y. Chen, Y. Shi, Z. Tang, T. F. Zheng, Deep factorization for speech signal, in: 2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), IEEE, 5094–5098, 2018.
- Sun _et al._ \[2017\] S. Sun, B. Zhang, L. Xie, Y. Zhang, An unsupervised deep domain adaptation approach for robust speech recognition, Neurocomputing 257 (2017) 79–87.
- Wang _et al._ \[2018\] Q. Wang, W. Rao, S. Sun, L. Xie, E. S. Chng, H. Li, Unsupervised domain adaptation via domain adversarial training for speaker recognition, in: 2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), IEEE, 4889–4893, 2018.
- Takashima _et al._ \[2014\] R. Takashima, R. Aihara, T. Takiguchi, Y. Ariki, Noise-robust voice conversion based on sparse spectral mapping using non-negative matrix factorization, IEICE TRANSACTIONS on Information and Systems 97 (6) (2014) 1411–1418.
- Aihara _et al._ \[2015\] R. Aihara, T. Fujii, T. Nakashika, T. Takiguchi, Y. Ariki, Small-parallel exemplar-based voice conversion in noisy environments using affine non-negative matrix factorization, EURASIP Journal on Audio, Speech, and Music Processing 2015 (1) (2015) 1–9.
- Hsu _et al._ \[2017b\] W.-N. Hsu, Y. Zhang, J. Glass, Unsupervised learning of disentangled and interpretable representations from sequential data, in: Advances in neural information processing systems, 1878–1889, 2017b.
- Valentini-Botinhao _et al._ \[2016\] C. Valentini-Botinhao, X. Wang, S. Takaki, J. Yamagishi, Investigating RNN-based speech enhancement methods for noise-robust Text-to-Speech., in: SSW, 146–152, 2016.
- Yang _et al._ \[2020\] S. Yang, Y. Wang, L. Xie, Adversarial feature learning and unsupervised clustering based speech synthesis for found data with acoustic and textual noise, IEEE Signal Processing Letters 27 (2020) 1730–1734.
- Sekkate _et al._ \[2019\] S. Sekkate, M. Khalil, A. Adib, S. Ben Jebara, An Investigation of a Feature-Level Fusion for Noisy Speech Emotion Recognition, Computers 8 (4) (2019) 91.
- Hsu _et al._ \[2019\] W.-N. Hsu, Y. Zhang, R. J. Weiss, Y.-A. Chung, Y. Wang, Y. Wu, J. Glass, Disentangling correlated speaker and noise for speech synthesis via data augmentation and adversarial factorization, in: IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), IEEE, 5901–5905, 2019.
- Ganin _et al._ \[2016\] Y. Ganin, E. Ustinova, H. Ajakan, P. Germain, H. Larochelle, F. Laviolette, M. Marchand, V. Lempitsky, Domain-adversarial training of neural networks, The Journal of Machine Learning Research 17 (1) (2016) 2096–2030.
...
- Tu _et al._ \[2019\] Y. Tu, M.-W. Mak, J.-T. Chien, Variational Domain Adversarial Learning for Speaker Verification., in: Interspeech, 4315–4319, 2019.
- Liao _et al._ \[2018\] C.-F. Liao, Y. Tsao, H.-Y. Lee, H.-M. Wang, Noise adaptive speech enhancement using domain adversarial training, arXiv preprint arXiv:1807.07501 .
- Lim _et al._ \[2020\] H. Lim, Y. Kim, H. Kim, Cross-Informed Domain Adversarial Training for Noise-Robust Wake-Up Word Detection, IEEE Signal Processing Letters 27 (2020) 1769–1773.
- Okabe _et al._ \[2018\] K. Okabe, T. Koshinaka, K. Shinoda, Attentive Statistics Pooling for Deep Speaker Embedding, Proc. Interspeech 2018 (2018) 2252–2256.
- Tang _et al._ \[2019\] Y. Tang, G. Ding, J. Huang, X. He, B. Zhou, Deep speaker embedding learning with multi-level pooling for text-independent speaker verification, in: ICASSP 2019-2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), IEEE, 6116–6120, 2019.
- Mor _et al._ \[2018\] N. Mor, L. Wolf, A. Polyak, Y. Taigman, A universal music translation network, arXiv preprint arXiv:1805.07848 .
- Ulyanov _et al._ \[2016\] D. Ulyanov, A. Vedaldi, V. Lempitsky, Instance normalization: The missing ingredient for fast stylization, arXiv preprint arXiv:1607.08022 .
- Locatello _et al._ \[2019\] F. Locatello, S. Bauer, M. Lucic, G. Raetsch, S. Gelly, B. Schölkopf, O. Bachem, Challenging common assumptions in the unsupervised learning of disentangled representations, in: international conference on machine learning, PMLR, 4114–4124, 2019.
- Lu _et al._ \[2013\] X. Lu, Y. Tsao, S. Matsuda, C. Hori, Speech enhancement based on deep denoising autoencoder., in: Interspeech, vol. 2013, 436–440, 2013.
...
- Veaux _et al._ \[2017\] C. Veaux, J. Yamagishi, K. MacDonald, _et al._, CSTR VCTK corpus: English multi-speaker corpus for CSTR voice cloning toolkit, University of Edinburgh. The Centre for Speech Technology Research (CSTR) .
- Vincent _et al._ \[2017\] E. Vincent, S. Watanabe, A. A. Nugraha, J. Barker, R. Marxer, An analysis of environment, microphone and data simulation mismatches in robust speech recognition, Computer Speech & Language 46 (2017) 535–557.
...
- Botinhao _et al._ \[2016\] C. V. Botinhao, X. Wang, S. Takaki, J. Yamagishi, Investigating RNN-based speech enhancement methods for noise-robust Text-to-Speech, in: 9th ISCA Speech Synthesis Workshop, 159–165, 2016.
- McFee _et al._ \[2015\] B. McFee, C. Raffel, D. Liang, D. P. Ellis, M. McVicar, E. Battenberg, O. Nieto, librosa: Audio and music signal analysis in python, in: Proceedings of the 14th python in science conference, vol. 8, 18–25, 2015.
- Yamamoto _et al._ \[2020\] R. Yamamoto, E. Song, J.-M. Kim, Parallel WaveGAN: A fast waveform generation model based on generative adversarial networks with multi-resolution spectrogram, in: International Conference on Acoustics, Speech and Signal Processing, IEEE, 6199–6203, 2020.
- Hu _et al._ \[2020\] Y. Hu, Y. Liu, S. Lv, M. Xing, S. Zhang, Y. Fu, J. Wu, B. Zhang, L. Xie, DCCRN: Deep Complex Convolution Recurrent Network for Phase-Aware Speech Enhancement., in: Interspeech, 2020.
...
- Rix _et al._ \[2001\] A. W. Rix, J. G. Beerends, M. P. Hollier, A. P. Hekstra, Perceptual evaluation of speech quality (PESQ)-a new method for speech quality assessment of telephone networks and codecs, in: 2001 IEEE International Conference on Acoustics, Speech, and Signal Processing. Proceedings (Cat. No. 01CH37221), vol. 2, IEEE, 749–752, 2001.
- Gulati _et al._ \[2020\] A. Gulati, J. Qin, C.-C. Chiu, N. Parmar, Y. Zhang, J. Yu, W. Han, S. Wang, Z. Zhang, Y. Wu, _et al._, Conformer: Convolution-augmented transformer for speech recognition, arXiv preprint arXiv:2005.08100 .
