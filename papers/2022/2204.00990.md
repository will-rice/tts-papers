...
arxiv_id: "2204.00990"
title:
  Content-Dependent Fine-Grained Speaker Embedding for Zero-Shot Speaker Adaptation
...
- \[3\] Y. Ren, C. Hu, X. Tan, T. Qin, S. Zhao, Z. Zhao, and T.-Y. Liu, “Fastspeech 2: Fast and high-quality end-to-end text to speech,” in _International Conference on Learning Representations_, 2021.
- \[4\] Y. Zhang, R. J. Weiss, H. Zen, Y. Wu, Z. Chen, R. Skerry-Ryan, Y. Jia, A. Rosenberg, and B. Ramabhadran, “Learning to speak fluently in a foreign language: Multilingual speech synthesis and cross-language voice cloning,” in _INTERSPEECH_, 2019, pp. 2080–2084.
- \[5\] M. Chen, X. Tan, Y. Ren, J. Xu, H. Sun, S. Zhao, T. Qin, and T.-Y. Liu, “Multispeech: Multi-speaker text to speech with transformer,” in _INTERSPEECH_, 2020, pp. 4024–4028.
- \[6\] X. Tan, T. Qin, F. Soong, and T.-Y. Liu, “A survey on neural speech synthesis,” _arXiv preprint arXiv:2106.15561_, 2021.
- \[7\] S. O. Arik, J. Chen, K. Peng, W. Ping, and Y. Zhou, “Neural voice cloning with a few samples,” in _Proceedings of the 32nd International Conference on Neural Information Processing Systems_, 2018, pp. 10 040–10 050.
- \[8\] M. Chen, X. Tan, B. Li, Y. Liu, T. Qin, S. Zhao, and T.-Y. Liu, “Adaspeech: Adaptive text to speech for custom voice,” in _International Conference on Learning Representations_, 2021.
- \[9\] Y. Yan, X. Tan, B. Li, T. Qin, S. Zhao, Y. Shen, and T.-Y. Liu, “Adaspeech 2: Adaptive text to speech with untranscribed data,” in _2021 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_.   IEEE, 2021, pp. 6613–6617.
- \[10\] Y. Yan, X. Tan, B. Li, G. Zhang, T. Qin, S. Zhao, Y. Shen, W.-Q. Zhang, and T.-Y. Liu, “Adaspeech 3: Adaptive text to speech for spontaneous style,” in _INTERSPEECH_, 2021.
- \[11\] Y. Jia, Y. Zhang, R. J. Weiss, Q. Wang, J. Shen, F. Ren, Z. Chen, P. Nguyen, R. Pang, I. L. Moreno _et al._, “Transfer learning from speaker verification to multispeaker text-to-speech synthesis,” in _Proceedings of the 32nd International Conference on Neural Information Processing Systems_, 2018, pp. 4485–4495.
- \[12\] E. Cooper, C.-I. Lai, Y. Yasuda, F. Fang, X. Wang, N. Chen, and J. Yamagishi, “Zero-shot multi-speaker text-to-speech with state-of-the-art neural speaker embeddings,” in _2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_.   IEEE, 2020, pp. 6184–6188.
- \[13\] Y. Zhang, H. Che, J. Li, C. Li, X. Wang, and Z. Wang, “One-shot voice conversion based on speaker aware module,” in _2021 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_.   IEEE, 2021, pp. 5959–5963.
- \[14\] H. Lu, Z. Wu, D. Dai, R. Li, S. Kang, J. Jia, and H. Meng, “One-shot voice conversion with global speaker embeddings,” in _INTERSPEECH_, 2019, pp. 669–673.
- \[15\] W.-N. Hsu, Y. Zhang, R. J. Weiss, H. Zen, Y. Wu, Y. Wang, Y. Cao, Y. Jia, Z. Chen, J. Shen _et al._, “Hierarchical generative modeling for controllable speech synthesis,” in _International Conference on Learning Representations_, 2018.
- \[16\] B. Nguyen and F. Cardinaux, “Nvc-net: End-to-end adversarial voice conversion,” _arXiv preprint arXiv:2106.00992_, 2021.
- \[17\] V. Klimkov, S. Ronanki, J. Rohnke, and T. Drugman, “Fine-grained robust prosody transfer for single-speaker neural text-to-speech,” _arXiv preprint arXiv:1907.02479_, 2019.
- \[18\] Y. Lee and T. Kim, “Robust and fine-grained prosody control of end-to-end speech synthesis,” in _2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, 2019, pp. 5911–5915.
- \[19\] X. Li, C. Song, J. Li, Z. Wu, J. Jia, and H. Meng, “Towards multi-scale style control for expressive speech synthesis,” in _INTERSPEECH_, 2021.
- \[20\] R. Fu, J. Tao, Z. Wen, and Y. Zheng, “Phoneme dependent speaker embedding and model factorization for multi-speaker speech synthesis and adaptation,” in _2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, 2019, pp. 6930–6934.
- \[21\] S. Choi, S. Han, D. Kim, and S. Ha, “Attentron: Few-shot text-to-speech utilizing attention-based variable-length embedding,” in _INTERSPEECH_, 2020, pp. 2007–2011.
- \[22\] S. Ioffe and C. Szegedy, “Batch normalization: Accelerating deep network training by reducing internal covariate shift,” in _International conference on machine learning_.   PMLR, 2015, pp. 448–456.
- \[23\] A. Vaswani, N. Shazeer, N. Parmar, J. Uszkoreit, L. Jones, A. N. Gomez, Ł. Kaiser, and I. Polosukhin, “Attention is all you need,” in _Advances in Neural Information Processing Systems_, 2017, pp. 5998–6008.
- \[24\] M. McAuliffe, M. Socolof, S. Mihuc, M. Wagner, and M. Sonderegger, “Montreal forced aligner: Trainable text-speech alignment using kaldi,” in _INTERSPEECH_, 2017, pp. 498–502.
- \[25\] Y. Shi, H. Bu, X. Xu, S. Zhang, and M. Li, “Aishell-3: A multi-speaker mandarin tts corpus and the baselines,” in _INTERSPEECH_, 2021, pp. 2756–2760.
- \[26\] J. Kong, J. Kim, and J. Bae, “Hifi-gan: Generative adversarial networks for efficient and high fidelity speech synthesis,” _Advances in Neural Information Processing Systems_, vol. 33, 2020.
- \[27\] L. Wan, Q. Wang, A. Papir, and I. L. Moreno, “Generalized end-to-end loss for speaker verification,” in _2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_.   IEEE, 2018, pp. 4879–4883.
