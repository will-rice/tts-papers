...
- Andreev et al. (2022) Pavel Andreev, Aibek Alanov, Oleg Ivanov, and Dmitry Vetrov. Hifi++: a unified framework for neural vocoding, bandwidth extension and speech enhancement. _arXiv e-prints_, pp.  arXiv–2203, 2022.
...
- Latorre et al. (2019) Javier Latorre, Jakub Lachowicz, Jaime Lorenzo-Trueba, Thomas Merritt, Thomas Drugman, Srikanth Ronanki, and Viacheslav Klimkov. Effect of data reduction on sequence-to-sequence neural tts. In _ICASSP 2019-2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pp.  7075–7079. IEEE, 2019.
- Luong et al. (2019) Hieu-Thi Luong, Xin Wang, Junichi Yamagishi, and Nobuyuki Nishizawa. Training multi-speaker neural text-to-speech systems using speaker-imbalanced speech corpora. _arXiv preprint arXiv:1904.00771_, 2019.
- Ogayo et al. (2022) Perez Ogayo, Graham Neubig, and Alan W Black. Building TTS systems for low resource languages under resource constraints. In _Proc. 1st Workshop on Speech for Social Good (S4SG)_, 2022.
- Ogun et al. (2023) Sewade Ogun, Vincent Colotte, and Emmanuel Vincent. Can we use common voice to train a multi-speaker tts system? In _2022 IEEE Spoken Language Technology Workshop (SLT)_, pp.  900–905. IEEE, 2023.
- Owomugisha et al. (2023) Isaac Owomugisha, Benjamin Akera, Ernest Tonny Mwebaze, and John Quinn. Multilingual model and data resources for text-to-speech in ugandan languages. In _4th Workshop on African Natural Language Processing_, 2023.
...
- Yamamoto et al. (2019) Ryuichi Yamamoto, Eunwoo Song, and Jae-Min Kim. Probability density distillation with generative adversarial networks for high-quality parallel waveform generation. _arXiv preprint arXiv:1904.04472_, 2019.
