...
Electric guitar effects such as distortion usually act as a decisive factor across various musical genres affecting the emotion, color, and the aesthetic taste of music. For many music information retrieval (MIR) tasks, however, such guitar effects add another layer of complexity and can degrade the performance of MIR models. For example, for automatic music transcription, Chen et al. \[[1](https://arxiv.org/html/2407.16639v1#bib.bib1)\] found that guitar signals with different pedal effects negatively impact the accuracy of transcription. As such, *distortion recovery*, the task of automatically removing effects from recorded tracks *post hoc*, may provide a solution improving the performance of MIR models, including transcription, source separation and automatic mixing systems \[[2](https://arxiv.org/html/2407.16639v1#bib.bib2), [3](https://arxiv.org/html/2407.16639v1#bib.bib3), [4](https://arxiv.org/html/2407.16639v1#bib.bib4)\]. For sound engineers, distortion recovery also make it easier for sound editing.
