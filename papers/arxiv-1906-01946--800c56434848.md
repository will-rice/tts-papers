...
arxiv_id: "1906.01946"
title:
  "Automated Speech Generation from UN General Assembly Statements: Mapping Risks
...
- Andersen et al. (2018) Andersen, L. et al. Human rights in the age of artificial intelligence. _Access Now_, 2018.
- Baturo et al. (2017) Baturo, A., Dasandi, N., and Mikhaylov, S. J. Understanding state preferences with text as data: Introducing the un general debate corpus. _Research & Politics_, 4(2), 2017.
...
- Council of Europe (2017) Council of Europe. Algorithms and human rights: Study on the human rights dimension of automated data processing techniques and possible regulatory implications. _Council of Europe Study DGI(2017)12_, 2017.
- Davidson et al. (2017) Davidson, T., Warmsley, D., Marcy, M., and Weber, I. Automated hate speech detection and the problem of offensive language. In _Proceedings of the 11th International AAAI Conference on Web and Social Media_. AAAI Press, 2017.
- Honnibal & Montani (2017) Honnibal, M. and Montani, I. spacy 2: Natural language understanding with bloom embeddings, convolutional neural networks and incremental parsing. _To appear_, 2017.
- Howard & Ruder (2018) Howard, J. and Ruder, S. Universal language model fine-tuning for text classification. In _Proceedings of the 56th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)_, pp.  328–339. Association for Computational Linguistics, 2018.
- Howard et al. (2018) Howard, J. et al. fastai, 2018.
- Ito (2018) Ito, J. _The Practice of Change_. PhD thesis, Keio Graduate School of Media and Governance, 2018.
- Kshirsagar et al. (2018) Kshirsagar, R., Cukuvac, T., McKeown, K., and McGregor, S. Predictive embeddings for hate speech detection on twitter. In _Proceedings of the 2nd Workshop on Abusive Language Online (ALW2)_, pp.  26–32. Association for Computational Linguistics, 2018.
...
- Merity et al. (2017b) Merity, S. et al. Pointer sentinel mixture models. In _Proceedings of the International Conference on Learning Representations (ICLR) 2017_, 2017b.
- OpenAI (2019) OpenAI. GPT-2. [https://github.com/openai/gpt-2](https://github.com/openai/gpt-2), 2019.
- Radford et al. (2018a) Radford, A. et al. Language models are unsupervised multitask learners. _OpenAI_, 2018a.
- Radford et al. (2018b) Radford, A. et al. Better language models and their implications. _OpenAI_, 2018b.
- Risse (2018) Risse, M. Human rights and artificial intelligence: An urgently needed agenda. _Carr Center for Human Rights Policy_, 2018.
- Seymore & Tull (2016) Seymore, J. and Tull, P. Weaponizing data science for social engineering: Automated E2E spear phishing on twitter. In _Black Hat conference_, 2016.
- Smith (2017) Smith, L. N. Cyclical learning rates for training neural networks. In _Applications of Computer Vision (WACV), 2017 IEEE Winter Conference_, pp.  464–472, 2017.
- Thies et al. (2016) Thies, J. et al. Face2face: Real-time face capture and reenactment of rgb videos. In _2016 IEEE Conference on Computer Vision and Pattern Recognition (CVPR)_, pp.  2387–2395, June 2016.
