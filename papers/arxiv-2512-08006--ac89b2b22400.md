...
arxiv_id: "2512.08006"
title:
  "Beyond Unified Models: A Service-Oriented Approach to Low Latency, Context
...
1.  1.  Homographs, i.e., words with multiple valid pronunciations depending on context (e.g., the English word read, pronounced either \tipaencoding/ri:d/ or \tipaencoding/rEd/ depending on tense), and
2.  2.  The Ezafe phoneme, a connecting /e/ sound that appears between grammatically or semantically related words, again determined by context.
...
1.  1.  Proposing a service-oriented approach for integrating neural components into real-time TTS systems,
2.  2.  Presenting a service-oriented adaptation of the well-known PiperTTS architecture,
3.  3.  Introducing a lightweight, fast, and context-aware phonemizer tailored to Persian phonemization challenges, an enhanced version of the existing eSpeak phonemizer, and
4.  4.  Providing a new Persian voice for Piper, trained on the largest publicly available Persian TTS dataset to date.
