...
- \[3\] D. Yarowsky, \`\`Homograph disambiguation in text-to-speech synthesis,'' in _Progress in speech synthesis_.   Springer, 1997, pp. 157–172.
- \[4\] K. Gorman, G. Mazovetskiy, and V. Nikolaev, \`\`Improving homograph disambiguation with supervised machine learning,'' in _LREC_, 2018.
- \[5\] M. Řezáčková, J. Švec, and D. Tihelka, \`\`T5G2P: Using Text-to-Text Transfer Transformer for Grapheme-to-Phoneme Conversion,'' in _Interspeech_, 2021.
- \[6\] A. Ploujnikov and M. Ravanelli, \`\`SoundChoice: Grapheme-to-Phoneme Models with Semantic Disambiguation,'' in _Interspeech_, 2022.
...
- \[8\] E. Fosler-Lussier, L. Dilley, N. R. Tyson, and M. A. Pitt, \`\`The buckeye corpus of speech: updates and enhancements.'' in _INTERSPEECH_, 2007. \[Online\]. Available: [http://dblp.uni-trier.de/db/conf/interspeech/interspeech2007.html#Fosler-LussierDTP07](http://dblp.uni-trier.de/db/conf/interspeech/interspeech2007.html#Fosler-LussierDTP07)
- \[9\] M. Nicolis and V. Klimkov, \`\`Homograph disambiguation with contextual word embeddings for TTS systems,'' in _Speech Synthesis Workshop (SSW 11)_, 2021.
...
- \[11\] K. Nishiyama, K. Yamamoto, and H. Nakajima, \`\`Dataset construction method for word reading disambiguation,'' in _Pacific Asia Conference on Language, Information and Computation_, 2018.
- \[12\] K. Matsuoka, E. Takeishi, H. Asano, R. Ichii, and Y. Ooyama, \`\`Natural language processing in a japanese text-to-speech system for written-style texts,'' in _Proceedings of IVTTA '96. Workshop on Interactive Voice Technology for Telecommunications Applications_, 1996, pp. 33–36.
- \[13\] H. Lu, Z. Ling, S. Wei, Y. Hu, L. Dai, and R. Wang, \`\`Heteronym verification for mandarin speech synthesis,'' in _2008 6th International Symposium on Chinese Spoken Language Processing_, 2008, pp. 1–4.
- \[14\] O. Tatanov, S. Beliaev, and B. Ginsburg, \`\`Mixer-tts: non-autoregressive, fast and compact text-to-speech model conditioned on language model embeddings,'' in _ICASSP 2022-2022 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_.   IEEE, 2022, pp. 7482–7486.
- \[15\] R. Badlani, A. Łańcucki, K. J. Shih, R. Valle, W. Ping, and B. Catanzaro, \`\`One TTS alignment to rule them all,'' in _ICASSP_, 2022.
- \[16\] K. J. Shih, R. Valle, R. Badlani, A. Lancucki, W. Ping, and B. Catanzaro, \`\`Rad-tts: Parallel flow-based TTS with robust alignment learning and diverse synthesis,'' in _ICML Workshop on Invertible Neural Networks, Normalizing Flows, and Explicit Likelihood Models_, 2021.
- \[17\] J. Zhu, C. Zhang, and D. Jurgens, \`\`ByT5 model for massively multilingual grapheme-to-phoneme conversion,'' in _Interspeech_, 2022.
...
- \[19\] E. Bakhturina, V. Lavrukhin, B. Ginsburg, and Y. Zhang, \`\`Hi-Fi Multi-Speaker English TTS Dataset,'' in _Interspeech_, 2021.
- \[20\] J. Devlin, M.-W. Chang, K. Lee, and K. Toutanova, \`\`BERT: Pre-training of deep bidirectional transformers for language understanding,'' in _"Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies"_, 2019.
