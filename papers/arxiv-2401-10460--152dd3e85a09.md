...
1.  1.  Fundamental Frequency $`F0`$ (1-dim Hz value)
2.  2.  Periodicity $`P`$ (12-dim mel band-wise ratio between periodic (only impulse train) and aperiodic excitation (only noise)) \[17\]
3.  3.  Vocal Tract Filter $`V`$ (257-dim linear frequency log magnitude)
