...
|  Hybrid-Mamba (Concat) |  Mamba text encoder paired with *attention-based* duration and style modules; diffusion decoder receives concatenated SSM features and attention-derived style signals. |
