...
|  |  |  |  |  |
|----|----|----|----|----|
| Method | A-CE$`\uparrow`$ | CER $`\downarrow`$ | CMOS_(s) $`\downarrow`$ | SSIM $`\uparrow`$ |
| LVC Models |  |  |  |  |
...
|  |  |  |  |  |  |  |  |
|----|----|----|----|----|----|----|----|
| Method | A-CE$`\uparrow`$ | CER $`\downarrow`$ | CMOS_(s) $`\downarrow`$ | SSIM $`\uparrow`$ | CMOS_(p)$`\downarrow`$ | F0_(cor) $`\uparrow`$ | PSIM $`\uparrow`$ |
| In LVC Mode |  |  |  |  |  |  |  |
...
|----|----|----|----|----|----|----|----|----|----|
| Method | EVC |  |  |  | SVC |  |  | LVC |  |
|  | CER   $`\uparrow`$ | SSIM $`\uparrow`$ | F0_(cor) $`\uparrow`$ | PSIM $`\uparrow`$ | CER $`\uparrow`$ | SSIM $`\uparrow`$ | F0_(cor) $`\uparrow`$ | CER $`\uparrow`$ | SSIM $`\uparrow`$ |
