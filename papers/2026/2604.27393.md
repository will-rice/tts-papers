...
Vision-Language Understanding. We evaluate vision-language understanding across five representative domains. (1) *STEM and general multimodal reasoning*. For general vision-language comprehension, we include OpenCompass (Contributors, 2023), MMBench V1.1 (Liu et al., 2024a), MMVet (Yu et al., 2024c), and MMStar (Chen et al., 2024a), which cover diverse multimodal tasks. For STEM-oriented reasoning, we include MMMU (Yue et al., 2024), MathVista (Lu et al., 2024), and AI2D (Kembhavi et al., 2016), covering scientific knowledge, mathematical reasoning, and diagram understanding. We further include MMT-Bench (Ying et al., 2024) and MM-IFEval (Ding et al., 2025) to assess multitask generalization and multimodal instruction following. (2) *Document and OCR understanding*. This domain evaluates the ability to recognize, extract, and reason over text in visually rich documents and scene images. We use OCRBench (Liu et al., 2024b), TextVQA (Singh et al., 2019), DocVQA (Mathew et al., 2021), and OmniDocBench (Ouyang et al., 2024), which require joint modeling of textual content, visual layout, and document structure. (3) *Multi-image understanding*. This domain measures the ability to aggregate and compare information across multiple images. We adopt Mantis-Eval (Jiang et al., 2024), MUIRBench (Wang et al., 2024a), and MMSI-Bench (Yang et al., 2025a), which evaluate cross-image reasoning, visual comparison, and multi-image information integration. (4) *Hallucination*. This domain evaluates whether model responses remain faithful to the visual input. We use HallusionBench (Guan et al., 2024) and MMHal-Bench (Sun et al., 2023), which measure visual consistency and hallucination in multimodal generation. (5) *Video understanding*. This domain evaluates spatio-temporal reasoning and motion understanding in videos. We use Video-MME (Fu et al., 2025), LVBench (Wang et al., 2024b), MLVU (Zhou et al., 2025a), LongVideoBench (Wu et al., 2024), and MotionBench (Hong\* et al., 2024), covering both varying video lengths.
