...
   Datasets        Gemini-3.1 Pro        Qwen3.5-Omni-Flash        Qwen3.5-Omni-Plus    Text Query QA    DailyOmni    82.7    81.8    84.6    WorldSense    65.5    57.9    62.8    AVUT    85.6    81.4    85.0    AV-SpeakerBench    75.1    65.2    71.3    VideoMME\_(w/ audio)^(a)    89.0    79.3    83.7    Audio Query QA    Qualcomm IVD    66.2    66.3    68.5    Caption    Omni-Cloze    57.2    63.0    64.8    Agent (Tool Use)    OmniGAIA^(b)    68.9    33.9    57.2 a VideoMME is evaluated with use_audio_in_video=True. b OmniGAIA is evaluated without a thinking prompt and without \<answer\> formatting. All results are evaluated using DeepSeek-V3.2-Thinking as the judge.
...
| Content Consistency    |                                              |             |
| SEED test-zh — test-en | Seed-TTS\_(ICL) (Anastassiou et al., 2024)   | 1.11 — 2.24 |
|                        | Seed-TTS\_(RL) (Anastassiou et al., 2024)    | 1.00 — 1.94 |
