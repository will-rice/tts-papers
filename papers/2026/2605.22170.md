...
arxiv_id: "2605.22170"
title:
  Do Factual Recall Mechanisms Carry over from Text to Speech in Multimodal Language
  Models?
authors:
  - Luca Modica
  - Filip Landin
...
1.  1.  T$`\rightarrow`$T (text-to-text): where the model receives and produces text.
2.  2.  S$`\rightarrow`$T (speech-to-text): where the model takes audio as input but still generates a text output.
