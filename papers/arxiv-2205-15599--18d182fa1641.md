...
1.  1.  A monolingual news corpus,
2.  2.  Authentic and synthetic parallel corpora in English, Spanish and Turkish paired with Judeo-Spanish,
3.  3.  A Spanish to Judeo-Spanish rule-based machine translation system,
4.  4.  Neural machine translation models between Judeo-Spanish and English, Spanish and Turkish,
5.  5.  A 3.5 hour single speaker speech corpus,
6.  6.  Neural network-based speech synthesis model,
7.  7.  Web application for MT and TTS²²2[http://translate.sefarad.com.tr](http://translate.sefarad.com.tr).
