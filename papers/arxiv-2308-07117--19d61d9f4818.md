...
arxiv_id: "2308.07117"
title:
  "iSTFTNet2: Faster and More Lightweight iSTFT-Based Neural Vocoder Using 1D-2D
  CNN"
authors:
  - Takuhiro Kaneko
  - Hirokazu Kameoka
...
- \[5\] D. P. Kingma and P. Dhariwal, \`\`Glow: Generative flow with invertible $`1 \times 1`$ convolutions,'' in _Proc. NeurIPS_, 2018, pp. 10 236–10 245.
