---
arxiv_id: '2104.07777'
title: 'Proteno: Text Normalization with Limited Data for Fast Deployment in Text
  to Speech Systems'
authors:
- Shubhi Tyagi
- Antonio Bonafonte
...
## References
- A. Conkie and A. Finch (2020)  A. Conkie and A. Finch. 2020. Scalable Multilingual Frontend for TTS. In *ICASSP 2020 - 2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 6684–6688.
- Ebden and Sproat (2014) Peter Ebden and Richard Sproat. 2014. [The Kestrel TTS text normalization system](https://doi.org/10.1017/S1351324914000175). *Natural Language Engineering*, 21:333–353.
- Eckart and Quasthoff (2013) Thomas Eckart and Uwe Quasthoff. 2013. [*Statistical Corpus and Language Comparison on Comparable Corpora*](https://doi.org/10.1007/978-3-642-20128-8_8), pages 151–165. Springer Berlin Heidelberg, Berlin, Heidelberg.
- Hochreiter and Schmidhuber (1997) Sepp Hochreiter and Jürgen Schmidhuber. 1997. [Long Short-Term Memory](https://doi.org/10.1162/neco.1997.9.8.1735). *Neural Comput.*, 9(8):1735–1780.
...
- Levenshtein (1966) Vladimir Iosifovich Levenshtein. 1966. Binary codes capable of correcting deletions, insertions and reversals. *Soviet Physics Doklady*, 10(8):707–710. Doklady Akademii Nauk SSSR, V163 No4 845-848 1965.
- Mansfield et al. (2019) Courtney Mansfield, Ming Sun, Yuzong Liu, Ankur Gandhe, and Björn Hoffmeister. 2019. [Neural text normalization with subword units](https://doi.org/10.18653/v1/N19-2024). In *Proceedings of the 2019 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies, Volume 2 (Industry Papers)*, pages 190–196, Minneapolis, Minnesota. Association for Computational Linguistics.
...
- Nikulásdóttir and Guðnason (2019) Anna Björk Nikulásdóttir and Jón Guðnason. 2019. [Bootstrapping a Text Normalization System for an Inflected Language. Numbers as a Test Case](https://doi.org/10.21437/Interspeech.2019-2367). In *Proc. Interspeech 2019*, pages 4455–4459.
- Pramanik and Hussain (2019) Subhojeet Pramanik and Aman Hussain. 2019. [Text normalization using memory augmented neural networks](https://doi.org/10.1016/j.specom.2019.02.003). *Speech Communication*, 109:15–23.
- Ramasamy et al. (2012) Loganathan Ramasamy, Ondřej Bojar, and Zdeněk Žabokrtský. 2012. Morphological Processing for English-Tamil Statistical Machine Translation. In *Proceedings of the Workshop on Machine Translation and Parsing in Indian Languages (MTPIL-2012)*, pages 113–122.
- Sodimana et al. (2018) Keshan Sodimana, Pasindu De Silva, Richard Sproat, A Theeraphol, Chen Fang Li, Alexander Gutkin, Supheakmungkol Sarin, and Knot Pipatsrisawat. 2018. [Text normalization for bangla, khmer, nepali, javanese, sinhala, and sundanese tts systems](https://www.isca-speech.org/archive/SLTU_2018/pdfs/Keshan2.pdf). In *6th International Workshop on Spoken Language Technologies for Under-Resourced Languages (SLTU-2018)*, pages 147–151, 29–31 August, Gurugram, India.
- Sproat (1996) Richard Sproat. 1996. [Multilingual text analysis for text-to-speech synthesis](https://doi.org/10.1017/S1351324997001654). *Natural Language Engineering*, 2(4):369–380.
- Sproat et al. (2001) Richard Sproat, Alan W. Black, Stanley Chen, Shankar Kumar, Mari Ostendorf, and Christopher Richards. 2001. [Normalization of Non-standard Words](https://doi.org/10.1006/csla.2001.0169). *Comput. Speech Lang.*, 15(3):287–333.
- Sproat and Jaitly (2016) Richard Sproat and Navdeep Jaitly. 2016. [RNN Approaches to Text Normalization: A Challenge](http://arxiv.org/abs/1611.00068). *CoRR*, abs/1611.00068.
- Sproat and Jaitly (2017) Richard Sproat and Navdeep Jaitly. 2017. [An RNN Model of Text Normalization](https://doi.org/10.21437/Interspeech.2017-35). In *Proc. Interspeech 2017*, pages 754–758.
- Sutskever et al. (2014) Ilya Sutskever, Oriol Vinyals, and Quoc V. Le. 2014. [Sequence to Sequence Learning with Neural Networks](http://arxiv.org/abs/1409.3215). *CoRR*, abs/1409.3215.
- Taylor (2009) Paul Taylor. 2009. [*Text-to-Speech Synthesis*](https://doi.org/10.1017/CBO9780511816338). Cambridge University Press.
- Vaswani et al. (2017) Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz Kaiser, and Illia Polosukhin. 2017. [Attention Is All You Need](http://arxiv.org/abs/1706.03762). *CoRR*, abs/1706.03762.
- Zhang et al. (2019) Hao Zhang, Richard Sproat, Axel H. Ng, Felix Stahlberg, Xiaochang Peng, Kyle Gorman, and Brian Roark. 2019. [Neural Models of Text Normalization for Speech Applications](https://doi.org/10.1162/COLI_a_00349). *Computational Linguistics*, pages 1–49.
