...
We start with pre-trained BERT\_(base) model of \[14\]. Using the implementation introduced in \[24\], we first pre-train using a masked LM target with learning rate $`3\hspace{0pt}\text{e-}\hspace{0pt}5`$ for 10 epochs, followed by 3 epochs of fine-tuning on the intent classification task with learning rate $`2\hspace{0pt}\text{e-}\hspace{0pt}5`$. This text-to-intent BERT based classifier trained on 20hTrainset gives 92.0% accuracy on human-generated reference transcripts.
